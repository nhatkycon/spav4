...
namespace docsoft.entities
{
    ...
    public class LienHeDal
    {
        ...
        public static LienHe Update(LienHe Updated)
        {
            ...
            obj[3] = new SqlParameter("LH_Ten", Updated.Ten);
            obj[4] = new SqlParameter("LH_DiaChi", Updated.DiaChi);
            obj[5] = new SqlParameter("LH_CongTy", Updated.CongTy);
            obj[6] = new SqlParameter("LH_Email", Updated.Email);
            obj[7] = new SqlParameter("LH_Mobile", Updated.Mobile);
            obj[8] = new SqlParameter("LH_Phone", Updated.Phone);
            obj[9] = new SqlParameter("LH_Skype", Updated.Skype);
            obj[10] = new SqlParameter("LH_Ym", Updated.Ym);
            obj[11] = new SqlParameter("LH_Website", Updated.Website);
            obj[12] = new SqlParameter("LH_NgayTao", Updated.NgayTao);
            obj[13] = new SqlParameter("LH_NgayCapNhat", Updated.NgayCapNhat);
            obj[14] = new SqlParameter("LH_NguoiTao", Updated.NguoiTao);
            obj[15] = new SqlParameter("LH_NguoiCapNhat", Updated.NguoiCapNhat);
            obj[16] = new SqlParameter("LH_Active", Updated.Active);
            obj[17] = new SqlParameter("LH_RowId", Updated.RowId);
            obj[18] = new SqlParameter("LH_GioiTinh", Updated.GioiTinh);
            obj[19] = new SqlParameter("LH_ChucDanh", Updated.ChucDanh);
            obj[20] = new SqlParameter("LH_Anh", Updated.Anh);
