...
namespace docbao.entitites
{
    ...
    public class ChannelDal
    {
        ...
        public static Channel Insert(Channel Inserted)
        {
            ...
            obj[7] = new SqlParameter("C_IsRss", Inserted.IsRss);
            obj[8] = new SqlParameter("C_Class", Inserted.Class);
            obj[9] = new SqlParameter("C_Class_Detail", Inserted.Class_Detail);
            obj[10] = new SqlParameter("C_Class_Item", Inserted.Class_Item);
            obj[11] = new SqlParameter("C_Class_Mota", Inserted.Class_Mota);
            obj[12] = new SqlParameter("C_Class_Title", Inserted.Class_Title);
        ...
        public static Channel Insert(Int32? id, String ten, Int32? b_id, Int32? dm_id, String dm_ten, String rssurl, Guid? rowid, Int32? tongsolink, Boolean isRss, String _class)
        {
            Channel Item = new Channel();
            ...
            if (isRss != null)
            {
                obj[7] = new SqlParameter("C_IsRss", isRss);
            }
            else
            {
                obj[7] = new SqlParameter("C_IsRss", DBNull.Value);
            }

            if (_class != null)
            {
                obj[8] = new SqlParameter("C_Class", _class);
            }
            else
            {
                obj[8] = new SqlParameter("C_Class", DBNull.Value);
            }
            using (IDataReader rd = SqlHelper.ExecuteReader(DAL.con(), CommandType.StoredProcedure, "tblRss_sp_tblRssChannel_Insert_InsertNormal_linhnx", obj))
            {
                while (rd.Read())
        ...
        public static Channel Update(Channel Updated)
        {
            ...
            obj[8] = new SqlParameter("C_IsRss", Updated.IsRss);
            obj[9] = new SqlParameter("C_Class", Updated.Class);
            obj[10] = new SqlParameter("C_Class_Detail", Updated.Class_Detail);
            obj[11] = new SqlParameter("C_Class_Item", Updated.Class_Item);
            obj[12] = new SqlParameter("C_Class_Mota", Updated.Class_Mota);
            obj[13] = new SqlParameter("C_Class_Title", Updated.Class_Title);
        ...
        public static Channel Update(Int32? id, String ten, Int32? b_id, Int32? dm_id, String dm_ten, String rssurl, Guid? rowid, Int32? tongsolink, Boolean isRss, String _class)
        {
            Channel Item = new Channel();
            ...
            if (isRss != null)
            {
                obj[8] = new SqlParameter("C_IsRss", isRss);
            }
            else
            {
                obj[8] = new SqlParameter("C_IsRss", DBNull.Value);
            }

            if (_class != null)
            {
                obj[9] = new SqlParameter("C_Class", _class);
            }
            else
            {
                obj[9] = new SqlParameter("C_Class", DBNull.Value);
            }
            using (IDataReader rd = SqlHelper.ExecuteReader(DAL.con(), CommandType.StoredProcedure, "tblRss_sp_tblRssChannel_Update_UpdateNormal_linhnx", obj))
            {
                while (rd.Read())
