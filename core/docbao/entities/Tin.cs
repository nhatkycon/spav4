...
namespace docbao.entitites
{
    ...
    public class TinDal
    {
        ...
        #endregion
        #region Extend
        public static TinCollection ThemTinDanhMuc(string T_ID, string DM_ID, string Username)
        {
            SqlParameter[] obj = new SqlParameter[3];
            obj[0] = new SqlParameter("TIN_ID", T_ID);
            ...
            TinCollection List = new TinCollection();
            using (IDataReader rd = SqlHelper.ExecuteReader(DAL.con(), CommandType.StoredProcedure, "sp_tblTinlaytin_Insert_ThemTinDanhMuc_linhnx", obj))
            {
                while (rd.Read())
                {
                    List.Add(getFromReader(rd));
        ...
        public static Pager<Tin> pagerDanhMuc(string url, bool rewrite,string dm_ten)
        {
            ...
            Pager<Tin> pg = new Pager<Tin>("tblRss_sp_tblTin_Pager_danhMuc_linhnx", "Pages", 10, 10, rewrite, url, obj);
            return pg;
        }
        public static Pager<Tin> pagerChuyenMuc(string url, bool rewrite, string cm_ten)
        {
            ...
            Pager<Tin> pg = new Pager<Tin>("tblRss_sp_tblTin_Pager_chuyenMuc_linhnx", "Pages", 10, 10, rewrite, url, obj);
            return pg;
        }
...
<div class=""slide"">
    ...
    <img class=""tin-item-img"" width=""749"" height=""400"" src=""{12}/lib/up/{1}""></a>
    <div class=""caption"">
    <p><b>{5}</b><br/>{6}</p>
    </div>
</div>"         , domain
                , Lib.imgSize(item.Anh, "749x400")
