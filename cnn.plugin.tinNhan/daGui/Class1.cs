...
using System.Xml;
using System.IO;
[assembly: WebResource("cnn.plugin.tinNhan.daGui.JScript1.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResource("cnn.plugin.tinNhan.daGui.htm.htm", "text/html")]
[assembly: WebResource("cnn.plugin.tinNhan.daGui.htm1.htm", "text/html")]
[assembly: WebResource("cnn.plugin.tinNhan.daGui.htm2.htm", "text/html")]
namespace cnn.plugin.tinNhan.daGui
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                case "get":
                    ...
                    Pager<Tinnhan> pager = TinnhanDal.GetTindagui("", false, jgrsidx + " " + jgrsord, Security.Username,_s);
                    string list;
                    string[] _arlist;
                    ...
                    foreach (Tinnhan item in pager.List)
                    {
                        ...
                        //if (item.slNguoinhan>1)
                        //    item.Nguoinhan = string.Format("({0}){1} ...", item.slNguoinhan.ToString(), item.Nguoinhan);
                        ...
                        item.Tieude = string.Format(@"<a href=""javascript:tinnhandaguiObj.selectRow('{0}')"" >{1}</a>", item.TinID, item.Tieude);
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.tinNhan.daGui.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region nạp
...
<div class=""mdl-head"">
    <span class=""mdl-head-searchPnl ui-state-default ui-corner-all"">
        ...
        <input type=""text"" class=""mdl-head-txt mdl-head-search mdl-head-search-tinnhandagui"" />
    </span>
    <a class=""mdl-head-btn mdl-head-add"" id=""tinnhandaguimdl-troveBtn"" href=""javascript:tinnhandaguiObj.quaylai();"">Trở về</a>
    <a class=""mdl-head-btn mdl-head-add"" id=""tinnhandaguimdl-chuyentiepBtn"" href=""javascript:tinnhandaguiObj.chuyentiep();"">Chuyển tiếp</a>
    <a class=""mdl-head-btn mdl-head-add"" id=""tinnhandaguimdl-traloiBtn"" href=""javascript:tinnhandaguiObj.traloi();"">Trả lời</a>

    <a class=""mdl-head-btn mdl-head-del"" id=""tinnhandaguimdl-datcoBtn"" href=""javascript:tinnhandaguiObj.datco();"">Đặt cờ</a>
    <a class=""mdl-head-btn mdl-head-del"" id=""tinnhandaguimdl-bocoBtn"" href=""javascript:tinnhandaguiObj.boco();"">Bỏ cờ</a>
    
    <a class=""mdl-head-btn mdl-head-del"" id=""tinnhandaguimdl-delBtn"" href=""javascript:tinnhandaguiObj.del();"">Xóa</a>

    <select id=""tinnhandaguimdl-chuyentoiDop"" size=""1"" onChange=""tinnhandaguiObj.chuyentoi(this)"">
...
<input style=""display:none""  id=""tinnhandaguimdl-TinID"" />
<div id=""tinnhandaguimdl-ListConten"">
    <div id=""tinnhandagui-List"">
        <table id=""tinnhandaguimdl-List"" class=""mdl-list""></table>
    </div>
    <div id=""tinnhandaguimdl-Pager""></div>
</div>

");
                    sb.AppendFormat(@"<script>$.getScript('{0}',function(){1});</script>"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.tinNhan.daGui.JScript1.js")
                        , "{tinnhandaguiObj.setup();}");
