var quangcaofn = {
    urlDefault: adm.urlDefault + '&act=loadPlug&rqPlug=projectMgr.plugin.backend.quangCao.Class1, projectMgr.plugin.backend.quangCao',
    setup: function () {
    },
    loadgrid: function () {
        ...
        $('#quangcaomdl-List').jqGrid({
            ...
            loadComplete: function () {
                ...
                adm.regType(typeof (danhmuc), 'docsoft.plugin.danhmuc.Class1, docsoft.plugin.danhmuc', function () {
                    danhmuc.autoCompleteByLoai('ADV', txtfilter, function (event, ui) {
    ...
    loadHtml: function (fn) {
        ...
        if ($(dlg).length < 1) {
            ...
            $.ajax({
                url: '<%=WebResource("projectMgr.plugin.backend.quangCao.htm.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
                    if (typeof (fn) == 'function') {
    ...
    addpopfn: function () {
        ...
        var ulpFn = function () {
            ...
            adm.uploadFull(uploadBtn, 'anh', _params, function (rs) {
        ...
        ulpFn();
        adm.regType(typeof (danhmuc), 'docsoft.plugin.danhmuc.Class1, docsoft.plugin.danhmuc', function () {
            danhmuc.autoCompleteByLoai('ADV', txtViTri, function (event, ui) {
