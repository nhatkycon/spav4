var tinfn = {
    ...
    loadgrid: function () {
        ...
        adm.regType(typeof (languageFn), 'cnn.plugin.language.Class1, cnn.plugin.language', function () {
            ...
            { name: 'TIN_ThuTu', width: 20, resizable: true, sortable: true, align: "center" },
            ...
            { name: 'TIN_Active', width: 30, resizable: true, sortable: true, align: "center", formatter: 'checkbox' },
...
//                            });
                        ...
                        adm.regQS($('.mdl-head-search-danhmuc'), 'tinmdl-List');
                        ...
                        open: function () {
                            ...
                            $.ajax({
                                ...
                                success: function (dt) {
                                    ...
                                    var newDlg = $('#tinmdl-dlgNew');
                                    //file upload
                                    var lbladm_uploadTintuc_fileLists = $('.adm-upload-fileLists', newDlg);
                                    //                                    var txtID = $('.ID', newDlg);
                                    //                                    $(txtID).val(data.ID);
    ...
    search: function () {
        ...
        timerSearch = setTimeout(function () {
            $('#tinmdl-List').jqGrid('setGridParam', { url: tinfn.urlDefault + "&subAct=get&q=" + q + "&DMID=" + dm + '&Lang=' + _Lang }).trigger("reloadGrid");
        }, 500);
    },
    ...
    addpopfn: function () {
        ...
        var _ID = ID.val();
        adm.regType(typeof (danhmuc), 'docsoft.plugin.danhmuc.Class1, docsoft.plugin.danhmuc', function () {
            danhmuc.autoCompleteLangBasedByDM(_ID, "TIN_TUC", txtDMID, function (event, ui) {
        ...
        //        setTimeout(function () {
        //            $(txtNoiDung_tt).next().find('iframe').css({ 'height': '200px' });
        //        }, 10000);
