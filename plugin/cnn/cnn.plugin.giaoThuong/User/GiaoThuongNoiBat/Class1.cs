...
[assembly: WebResource("cnn.plugin.giaoThuong.User.GiaoThuongNoiBat.JScript1.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResource("cnn.plugin.giaoThuong.User.GiaoThuongNoiBat.htm.htm", "text/html", PerformSubstitution = true)]

namespace cnn.plugin.giaoThuong.User.GiaoThuongNoiBat
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.giaoThuong.User.GiaoThuongNoiBat.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region Nạp
                    ...
                    sb.Append(@"
                 <div id=""GiaoThuongNoiBatFnMdl-main"">   
                    <div id=""GiaoThuongNoiBatFnMdl-head"" class=""mdl-head"">
                        <span class=""mdl-head-searchPnl ui-state-default ui-corner-all"">
                            <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                            <input type=""text"" class=""mdl-head-txt mdl-head-search mdl-head-search-GiaoThuongNoiBat"" />
                        </span>
                        <select class=""slt"" onchange=""GiaoThuongNoiBatFn.search();"" id=""GiaoThuongNoiBatFnMdl-changeLangSlt""></select>
                        <select class=""muaban"" onchange=""GiaoThuongNoiBatFn.search();"" id=""GiaoThuongNoiBatFnMdl-muaban""></select>
                        <select class=""TrangThai"" onchange=""GiaoThuongNoiBatFn.search();"" id=""GiaoThuongNoiBatFnMdl-TrangThai""></select>

                        <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                            <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                            <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterDanhMucGiaoThuongNoiBat""/>
                        </span>
                        <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                            <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                            <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterKhuVucGiaoThuongNoiBat""/>
                        </span>
                    </div>
                    <table id=""GiaoThuongNoiBatFnMdl-List"" class=""mdl-list""></table>
                    <div id=""GiaoThuongNoiBatFnMdl-Pager""></div>
                </div>
                    ");
                    sb.AppendFormat(@"<script>$.getScript('{0}',function(){1});</script>"
                    , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.giaoThuong.User.GiaoThuongNoiBat.JScript1.js")
                    , "{GiaoThuongNoiBatFn.loadgrid();}");
