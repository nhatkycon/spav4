GiaoThuongUserDanhSachTinGiaoThuongFn = {
    urlDefault: function () { return adm.urlDefault + '&act=loadPlug&rqPlug=cnn.plugin.giaoThuong.User.DanhSachTinGiaoThuong.Class1, cnn.plugin.giaoThuong'; },
    setup: function () { },
    thongbao: function () {
    ...
    loadgrid: function () {
        ...
        $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-subMdl').tabs({ show: function (event, ui) {
            if (ui.index == 0 && !initialized[0]) {
                $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-subLangMdl-List').jqGrid({
                    url: GiaoThuongUserDanhSachTinGiaoThuongFn.urlDefault().toString(),
                    datatype: 'json',
                    loadui: 'disable',
        ...
        var DMID = $('.mdl-head-search-GiaoThuongUserDanhSachTinGiaoThuong');
        adm.regType(typeof (languageFn), 'cnn.plugin.language.Class1, cnn.plugin.language', function () {
            languageFn.setup(function () {
                $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-List').jqGrid({
                    url: GiaoThuongUserDanhSachTinGiaoThuongFn.urlDefault().toString() + '&subAct=get&Lang=' + Lang,
                    datatype: 'json',
                    loadui: 'disable',
                    colNames: ['ID', 'LangBased', 'Lang', 'Ảnh', 'Tên', 'Mô tả', 'Danh mục', 'Xuất xứ', 'Ngày ĐK', 'Username', 'Publish', 'Active'],
                    colModel: [
                    ...
                    multiselect: true,
                    pager: $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-Pager'),
                    onSelectRow: function (rowid) {
                        GiaoThuongUserDanhSachTinGiaoThuongFn.loadSubGrid(rowid);
                    },
                    loadComplete: function () {
                        adm.loading(null);
                        var txtfilter = $('.mdl-head-filterDanhMucGiaoThuongUserDanhSachTinGiaoThuong', '#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-head');
                        var txtfilterTINH = $('.mdl-head-filterKhuVucGiaoThuongUserDanhSachTinGiaoThuong', '#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-head');
                        adm.regType(typeof (danhmuc), 'docsoft.plugin.danhmuc.Class1, docsoft.plugin.danhmuc', function () {
                            danhmuc.autoCompleteLangBased("", "SP_NHOM", txtfilter, function (event, ui) {
                                ...
                                GiaoThuongUserDanhSachTinGiaoThuongFn.search();
                            });
                ...
                var filterLoaiDanhMucID = $('.mdl-head-filterDanhMucGiaoThuongUserDanhSachTinGiaoThuong', '#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-head');
                var filterTINHID = $('.mdl-head-filterKhuVucGiaoThuongUserDanhSachTinGiaoThuong', '#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-head');
                var searchTxt = $('.mdl-head-search-GiaoThuongUserDanhSachTinGiaoThuong', '#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-head');
                ...
                var muaban = $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-muaban');
                ...
                var TrangThai = $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-TrangThai');
                $(TrangThai).find('option').remove();
                $(TrangThai).prepend('<option value="4">Còn hạn</option>');
                $(TrangThai).prepend('<option value="1">Quá hạn</option>');
                $(TrangThai).prepend('<option value="">--Trạng thái--</option>');
                $(TrangThai).val('--Trạng thái--');


                var changeLangBtn = $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-changeLangSlt');
    ...
    loadSubGrid: function (_id) {
        if (_id != null) {
            ...
            $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-subLangMdl-List').jqGrid('setGridParam', {
                url: GiaoThuongUserDanhSachTinGiaoThuongFn.urlDefault().toString() + "&subAct=getByLangBasedId" + "&LangBased_ID=" + _id
                , loadComplete: function () {
                    adm.loading(null);
                }
            }).trigger("reloadGrid");
    ...
    filterfn: function (_active, _pub) {
        $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-List').jqGrid('setGridParam', { url: GiaoThuongUserDanhSachTinGiaoThuongFn.urlDefault().toString() + "&subAct=get" + "&Active=" + _active + "&Publish=" + _pub }).trigger("reloadGrid");
    },
    EditLang: function () {
        var s = '';
        if (jQuery('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-subLangMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-subLangMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                GiaoThuongUserDanhSachTinGiaoThuongFn.loadHtml(function () {
                    var newDlg = $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-dlgNew');
                    GiaoThuongUserDanhSachTinGiaoThuongFn.popfn();
                    $(newDlg).dialog({
                        title: 'Sửa',
                        width: 750,
                        height: 550,
                        buttons: {
                            'Lưu': function () {
                                GiaoThuongUserDanhSachTinGiaoThuongFn.save(false, function () {
                                    GiaoThuongUserDanhSachTinGiaoThuongFn.clearform();
                                    jQuery('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-subLangMdl-List').trigger('reloadGrid');
                                });
                            },
                        ...
                        open: function () {
                            ...
                            adm.styleButton();
                            $.ajax({
                                url: GiaoThuongUserDanhSachTinGiaoThuongFn.urlDefault().toString() + '&subAct=edit',
                                dataType: 'script',
                                data: {
                                    'ID': s
                                },
...
//                                    if (dt.Hot4) { Hot4.attr('checked', 'checked'); } else { Hot4.removeAttr('checked'); }
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                if (confirm('Bạn có chắc chắn xóa danh mục này?')) {
                    $.ajax({
                        url: GiaoThuongUserDanhSachTinGiaoThuongFn.urlDefault().toString() + '&subAct=del',
                        dataType: 'script',
                        data: { 'ID': s },
                        success: function (dt) {
                            jQuery('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-subLangMdl-List').trigger('reloadGrid');
    ...
    search: function () {
        var timerSearch;
        var filterDM = $('.mdl-head-search-GiaoThuongUserDanhSachTinGiaoThuong');
        var searchDM = $('.mdl-head-filterDanhMucGiaoThuongUserDanhSachTinGiaoThuong');
        var searchTINH = $('.mdl-head-filterKhuVucGiaoThuongUserDanhSachTinGiaoThuong');
        var _Lang = $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-changeLangSlt').val();
        var filtermuaban = $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-muaban');
        var filterTrangThai = $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-TrangThai');
        var q = filterDM.val();
        if (q == 'Tìm kiếm tin') {
            q = '';
        }
        ...
        timerSearch = setTimeout(function () {
            $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-List').jqGrid('setGridParam', { url: GiaoThuongUserDanhSachTinGiaoThuongFn.urlDefault().toString() + '&subAct=get&dm=' + dm + '&dmkv=' + tinh + '&Lang=' + _Lang + '&q=' + q + '&muaban=' + muaban + '&trangthai=' + trangthai }).trigger('reloadGrid');
        }, 500);
    },
    add: function () {
        GiaoThuongUserDanhSachTinGiaoThuongFn.loadHtml(function () {
            ...
            $(newDlg).dialog({
                ...
                buttons: {
                    'Lưu': function () {
                        GiaoThuongUserDanhSachTinGiaoThuongFn.save(false, function () {
                            GiaoThuongUserDanhSachTinGiaoThuongFn.clearform();
                            jQuery('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-List').trigger('reloadGrid');
                        });
                    },
                    'Lưu và đóng': function () {
                        GiaoThuongUserDanhSachTinGiaoThuongFn.save(false, function () {
    ...
    loadHtml: function (fn) {
        var dlg = $('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.giaoThuong.User.DanhSachTinGiaoThuong.htm.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
    ...
    edit: function () {
        var s = '';
        if (jQuery('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
            alert('Chọn mẩu tin để sửa');
        }
...
//        var _Hot4 = Hot4.is(':checked');
        ...
        if (_LangBased_ID != '' && eval(_LangBased) == false) {
            $.ajax({
                url: GiaoThuongUserDanhSachTinGiaoThuongFn.urlDefault().toString() + '&subAct=CountLang',
                dataType: 'script',
                data: {
                    'ID': _LangBased_ID,
                    'Lang': _Lang
...
//                    'Hot4': _Hot4
    ...
    del: function () {
        var s = '';
        s = jQuery('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-List').jqGrid('getGridParam', 'selarrrow').toString();
    ...
    AddLang: function () {
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                var treedata = $("#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-List").jqGrid('getRowData', s);
...
//        Hot4.removeAttr('checked');
    ...
    DKDVVIP: function () {
        ...
        if (s == '') {
            alert('Chọn mẩu tin để đăng ký');
        }
        else {
            if (confirm('Bạn có chắc đăng ký những tin này?')) {
                $.ajax({
                    url: GiaoThuongUserDanhSachTinGiaoThuongFn.urlDefault().toString() + '&subAct=DKDVVIP',
                    dataType: 'script',
                    data: { 'ID': s },
                    success: function (dt) {
                        jQuery('#GiaoThuongUserDanhSachTinGiaoThuongFnMdl-List').trigger('reloadGrid');
