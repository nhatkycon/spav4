UserGiaoThuongMoiFn = {
    urlDefault: function () { return adm.urlDefault + '&act=loadPlug&rqPlug=cnn.plugin.giaoThuong.User.GiaoThuongMoi.Class1, cnn.plugin.giaoThuong'; },
    setup: function () { },
    thongbao: function () {
    ...
    loadgrid: function () {
        ...
        $('#UserGiaoThuongMoiFnMdl-subMdl').tabs({ show: function (event, ui) {
            if (ui.index == 0 && !initialized[0]) {
                $('#UserGiaoThuongMoiFnMdl-subLangMdl-List').jqGrid({
                    url: UserGiaoThuongMoiFn.urlDefault().toString(),
                    datatype: 'json',
                    loadui: 'disable',
        ...
        var DMID = $('.mdl-head-search-UserGiaoThuongMoi');
        adm.regType(typeof (languageFn), 'cnn.plugin.language.Class1, cnn.plugin.language', function () {
            languageFn.setup(function () {
                $('#UserGiaoThuongMoiFnMdl-List').jqGrid({
                    url: UserGiaoThuongMoiFn.urlDefault().toString() + '&subAct=get&Lang=' + Lang,
                    datatype: 'json',
                    loadui: 'disable',
                    colNames: ['ID', 'LangBased', 'Lang', 'Ảnh', 'Tên', 'Mô tả', 'Danh mục', 'Xuất xứ', 'Ngày ĐK', 'Username', 'Publish', 'Active'],
                    colModel: [
                    ...
                    multiselect: true,
                    pager: $('#UserGiaoThuongMoiFnMdl-Pager'),
                    onSelectRow: function (rowid) {
                        UserGiaoThuongMoiFn.loadSubGrid(rowid);
                    },
                    loadComplete: function () {
                        adm.loading(null);
                        var txtfilter = $('.mdl-head-filterDanhMucUserGiaoThuongMoi', '#UserGiaoThuongMoiFnMdl-head');
                        var txtfilterTINH = $('.mdl-head-filterKhuVucUserGiaoThuongMoi', '#UserGiaoThuongMoiFnMdl-head');
                ...
                var filterLoaiDanhMucID = $('.mdl-head-filterDanhMucUserGiaoThuongMoi', '#UserGiaoThuongMoiFnMdl-head');
                var filterTINHID = $('.mdl-head-filterKhuVucUserGiaoThuongMoi', '#UserGiaoThuongMoiFnMdl-head');
                var searchTxt = $('.mdl-head-search-UserGiaoThuongMoi', '#UserGiaoThuongMoiFnMdl-head');
                ...
                var muaban = $('#UserGiaoThuongMoiFnMdl-muaban');
                ...
                var TrangThai = $('#UserGiaoThuongMoiFnMdl-TrangThai');
                ...
                var changeLangBtn = $('#UserGiaoThuongMoiFnMdl-changeLangSlt');
    ...
    loadSubGrid: function (_id) {
        if (_id != null) {
            ...
            $('#UserGiaoThuongMoiFnMdl-subLangMdl-List').jqGrid('setGridParam', {
                url: UserGiaoThuongMoiFn.urlDefault().toString() + "&subAct=getByLangBasedId" + "&LangBased_ID=" + _id
                , loadComplete: function () {
                    adm.loading(null);
                }
            }).trigger("reloadGrid");
    ...
    filterfn: function (_active, _pub) {
        $('#UserGiaoThuongMoiFnMdl-List').jqGrid('setGridParam', { url: UserGiaoThuongMoiFn.urlDefault().toString() + "&subAct=get" + "&Active=" + _active + "&Publish=" + _pub }).trigger("reloadGrid");
    },
    EditLang: function () {
        var s = '';
        if (jQuery('#UserGiaoThuongMoiFnMdl-subLangMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#UserGiaoThuongMoiFnMdl-subLangMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                UserGiaoThuongMoiFn.loadHtml(function () {
                    var newDlg = $('#UserGiaoThuongMoiFnMdl-dlgNew');
                    UserGiaoThuongMoiFn.popfn();
                    $(newDlg).dialog({
                        title: 'Sửa',
                        width: 750,
                        height: 550,
                        buttons: {
                            'Lưu': function () {
                                UserGiaoThuongMoiFn.save(false, function () {
                                    UserGiaoThuongMoiFn.clearform();
                                    jQuery('#UserGiaoThuongMoiFnMdl-subLangMdl-List').trigger('reloadGrid');
                                });
                            },
                        ...
                        open: function () {
                            ...
                            adm.styleButton();
                            $.ajax({
                                url: UserGiaoThuongMoiFn.urlDefault().toString() + '&subAct=edit',
                                dataType: 'script',
                                data: {
                                    'ID': s
                                },
                                success: function (_dt) {
                                    ...
                                    var DM_ID = $('.danhMucSelection-List', newDlg);
                                    ...
                                    var Dm_id = dt.DM_ID;
                                    UserGiaoThuongMoiFn.LoadDanhMucIDList(Dm_id, DM_ID);
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                if (confirm('Bạn có chắc chắn xóa danh mục này?')) {
                    $.ajax({
                        url: UserGiaoThuongMoiFn.urlDefault().toString() + '&subAct=del',
                        dataType: 'script',
                        data: { 'ID': s },
                        success: function (dt) {
                            jQuery('#UserGiaoThuongMoiFnMdl-subLangMdl-List').trigger('reloadGrid');
    ...
    search: function () {
        var timerSearch;
        var filterDM = $('.mdl-head-search-UserGiaoThuongMoi');
        var searchDM = $('.mdl-head-filterDanhMucUserGiaoThuongMoi');
        var searchTINH = $('.mdl-head-filterKhuVucUserGiaoThuongMoi');
        var _Lang = $('#UserGiaoThuongMoiFnMdl-changeLangSlt').val();
        var filtermuaban = $('#UserGiaoThuongMoiFnMdl-muaban');
        var filterTrangThai = $('#UserGiaoThuongMoiFnMdl-TrangThai');
        var q = filterDM.val();
        if (q == 'Tìm kiếm tin') {
            q = '';
        }
        ...
        timerSearch = setTimeout(function () {
            $('#UserGiaoThuongMoiFnMdl-List').jqGrid('setGridParam', { url: UserGiaoThuongMoiFn.urlDefault().toString() + '&subAct=get&dm=' + dm + '&dmkv=' + tinh + '&Lang=' + _Lang + '&q=' + q + '&muaban=' + muaban + '&trangthai=' + trangthai }).trigger('reloadGrid');
        }, 500);
    },
    add: function () {
        UserGiaoThuongMoiFn.loadHtml(function () {
            ...
            $(newDlg).dialog({
                ...
                buttons: {
                    'Lưu': function () {
                        UserGiaoThuongMoiFn.save(false, function () {
                            UserGiaoThuongMoiFn.clearform();
                            jQuery('#UserGiaoThuongMoiFnMdl-List').trigger('reloadGrid');
                        });
                    },
                    'Lưu và đóng': function () {
                        UserGiaoThuongMoiFn.save(false, function () {
    ...
    popfn: function () {
        var newDlg = $('#UserGiaoThuongMoiFnMdl-dlgNew');
        adm.regType(typeof (danhmuc), 'docsoft.plugin.danhmuc.Class1, docsoft.plugin.danhmuc', function () {
            var danhMucSelectionList = $('.danhMucSelection-List', '#UserGiaoThuongMoiFnMdl-dlgNew');
            var DanhMucBox_show = $('.DanhMucBox_show', '#UserGiaoThuongMoiFnMdl-dlgNew');
            $('.danhMucSelection-Btn').click(function () {
                danhmuc.getSelectTionTest('SP_NHOM', danhMucSelectionList, DanhMucBox_show);
    ...
    loadHtml: function (fn) {
        var dlg = $('#UserGiaoThuongMoiFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.giaoThuong.User.GiaoThuongMoi.htm.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
    ...
    edit: function () {
        var s = '';
        if (jQuery('#UserGiaoThuongMoiFnMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#UserGiaoThuongMoiFnMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
            alert('Chọn mẩu tin để sửa');
        }
...
//                                    DM_ID.attr('_value', dt.DM_ID);
    ...
    save: function (validate, fn) {
        ...
        if (_LangBased_ID != '' && eval(_LangBased) == false) {
            $.ajax({
                url: UserGiaoThuongMoiFn.urlDefault().toString() + '&subAct=CountLang',
                dataType: 'script',
                data: {
                    'ID': _LangBased_ID,
                    'Lang': _Lang
    ...
    del: function () {
        var s = '';
        s = jQuery('#UserGiaoThuongMoiFnMdl-List').jqGrid('getGridParam', 'selarrrow').toString();
    ...
    AddLang: function () {
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                var treedata = $("#UserGiaoThuongMoiFnMdl-List").jqGrid('getRowData', s);
    ...
    DKDVVIP: function () {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc muốn đăng ký tin nổi bật?')) {
                $.ajax({
                    url: UserGiaoThuongMoiFn.urlDefault().toString() + '&subAct=DKDVVIP',
                    dataType: 'script',
                    data: { 'ID': s },
                    success: function (dt) {
                        jQuery('#UserGiaoThuongMoiFnMdl-List').trigger('reloadGrid');
    ...
    LoadDanhMucIDList: function (ID, _obj) {
        var obj = $(_obj);
        $.ajax({
            url: UserGiaoThuongMoiFn.urlDefault().toString() + '&subAct=ListDanhMucID',
            dataType: 'script',
            data: {
                'ID': ID
            },
            success: function (dt) {
                data = eval(dt);
                var count = 1;
                var countlengthdata = $(data).length - 1;
                obj.attr('value', ID);
                $.each(data, function (i, item) {
                    obj.append('<span class="spanlv' + count + '" level="' + count + '" _id="' + item.ID + '">' + item.Ten + '</span>');
                    if (i < countlengthdata) {
                        DM_ID.append('<span> >> </span>');
                    }
                });
            }
        });
