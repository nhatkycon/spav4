GiaoThuongChaoMuaFn = {
    urlDefault: function () { return adm.urlDefault + '&act=loadPlug&rqPlug=cnn.plugin.giaoThuong.ChaoMua.Class1, cnn.plugin.giaoThuong'; },
    setup: function () { },
    thongbao: function () {
    ...
    loadgrid: function () {
        ...
        $('#GiaoThuongChaoMuaFnMdl-subMdl').tabs({ show: function (event, ui) {
            if (ui.index == 0 && !initialized[0]) {
                $('#GiaoThuongChaoMuaFnMdl-subLangMdl-List').jqGrid({
                    url: GiaoThuongChaoMuaFn.urlDefault().toString(),
                    datatype: 'json',
                    loadui: 'disable',
        ...
        var DMID = $('.mdl-head-search-GiaoThuongChaoMua');
        adm.regType(typeof (languageFn), 'cnn.plugin.language.Class1, cnn.plugin.language', function () {
            languageFn.setup(function () {
                $('#GiaoThuongChaoMuaFnMdl-List').jqGrid({
                    url: GiaoThuongChaoMuaFn.urlDefault().toString() + '&subAct=get&Lang=' + Lang,
                    datatype: 'json',
                    loadui: 'disable',
                    colNames: ['ID', 'LangBased', 'Lang', 'Ảnh', 'Tên', 'Mô tả', 'Danh mục', 'Xuất xứ', 'Ngày ĐK', 'Username', 'Publish', 'Active'],
                    colModel: [
                    ...
                    multiselect: true,
                    pager: $('#GiaoThuongChaoMuaFnMdl-Pager'),
                    onSelectRow: function (rowid) {
                        GiaoThuongChaoMuaFn.loadSubGrid(rowid);
                    },
                    loadComplete: function () {
                        adm.loading(null);
                        var txtfilter = $('.mdl-head-filterDanhMucGiaoThuongChaoMua', '#GiaoThuongChaoMuaFnMdl-head');
                        var txtfilterTINH = $('.mdl-head-filterKhuVucGiaoThuongChaoMua', '#GiaoThuongChaoMuaFnMdl-head');
                ...
                var filterLoaiDanhMucID = $('.mdl-head-filterDanhMucGiaoThuongChaoMua', '#GiaoThuongChaoMuaFnMdl-head');
                var filterTINHID = $('.mdl-head-filterKhuVucGiaoThuongChaoMua', '#GiaoThuongChaoMuaFnMdl-head');
                var searchTxt = $('.mdl-head-search-GiaoThuongChaoMua', '#GiaoThuongChaoMuaFnMdl-head');
                ...
                var muaban = $('#GiaoThuongChaoMuaFnMdl-muaban');
                ...
                var TrangThai = $('#GiaoThuongChaoMuaFnMdl-TrangThai');
                ...
                var changeLangBtn = $('#GiaoThuongChaoMuaFnMdl-changeLangSlt');
    ...
    loadSubGrid: function (_id) {
        if (_id != null) {
            ...
            $('#GiaoThuongChaoMuaFnMdl-subLangMdl-List').jqGrid('setGridParam', {
                url: GiaoThuongChaoMuaFn.urlDefault().toString() + "&subAct=getByLangBasedId" + "&LangBased_ID=" + _id
                , loadComplete: function () {
                    adm.loading(null);
                }
            }).trigger("reloadGrid");
    ...
    filterfn: function (_active, _pub) {
        $('#GiaoThuongChaoMuaFnMdl-List').jqGrid('setGridParam', { url: GiaoThuongChaoMuaFn.urlDefault().toString() + "&subAct=get" + "&Active=" + _active + "&Publish=" + _pub }).trigger("reloadGrid");
    },
    EditLang: function () {
        var s = '';
        if (jQuery('#GiaoThuongChaoMuaFnMdl-subLangMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#GiaoThuongChaoMuaFnMdl-subLangMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                GiaoThuongChaoMuaFn.loadHtml(function () {
                    var newDlg = $('#GiaoThuongChaoMuaFnMdl-dlgNew');
                    GiaoThuongChaoMuaFn.popfn();
                    $(newDlg).dialog({
                        title: 'Sửa',
                        width: 750,
                        height: 550,
                        buttons: {
                            'Lưu': function () {
                                GiaoThuongChaoMuaFn.save(false, function () {
                                    GiaoThuongChaoMuaFn.clearform();
                                    jQuery('#GiaoThuongChaoMuaFnMdl-subLangMdl-List').trigger('reloadGrid');
                                });
                            },
                        ...
                        open: function () {
                            ...
                            adm.styleButton();
                            $.ajax({
                                url: GiaoThuongChaoMuaFn.urlDefault().toString() + '&subAct=edit',
                                dataType: 'script',
                                data: {
                                    'ID': s
                                },
...
//                                    if (dt.Hot4) { Hot4.attr('checked', 'checked'); } else { Hot4.removeAttr('checked'); }
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                if (confirm('Bạn có chắc chắn xóa danh mục này?')) {
                    $.ajax({
                        url: GiaoThuongChaoMuaFn.urlDefault().toString() + '&subAct=del',
                        dataType: 'script',
                        data: { 'ID': s },
                        success: function (dt) {
                            jQuery('#GiaoThuongChaoMuaFnMdl-subLangMdl-List').trigger('reloadGrid');
    ...
    search: function () {
        var timerSearch;
        var filterDM = $('.mdl-head-search-GiaoThuongChaoMua');
        var searchDM = $('.mdl-head-filterDanhMucGiaoThuongChaoMua');
        var searchTINH = $('.mdl-head-filterKhuVucGiaoThuongChaoMua');
        var _Lang = $('#GiaoThuongChaoMuaFnMdl-changeLangSlt').val();
        var filtermuaban = $('#GiaoThuongChaoMuaFnMdl-muaban');
        var filterTrangThai = $('#GiaoThuongChaoMuaFnMdl-TrangThai');
        var q = filterDM.val();
        if (q == 'Tìm kiếm tin') {
            q = '';
        }
        ...
        timerSearch = setTimeout(function () {
            $('#GiaoThuongChaoMuaFnMdl-List').jqGrid('setGridParam', { url: GiaoThuongChaoMuaFn.urlDefault().toString() + '&subAct=get&dm=' + dm + '&dmkv=' + tinh + '&Lang=' + _Lang + '&q=' + q + '&muaban=' + muaban + '&trangthai=' + trangthai }).trigger('reloadGrid');
        }, 500);
    },
    add: function () {
        GiaoThuongChaoMuaFn.loadHtml(function () {
            ...
            $(newDlg).dialog({
                ...
                buttons: {
                    'Lưu': function () {
                        GiaoThuongChaoMuaFn.save(false, function () {
                            GiaoThuongChaoMuaFn.clearform();
                            jQuery('#GiaoThuongChaoMuaFnMdl-List').trigger('reloadGrid');
                        });
                    },
                    'Lưu và đóng': function () {
                        GiaoThuongChaoMuaFn.save(false, function () {
    ...
    loadHtml: function (fn) {
        var dlg = $('#GiaoThuongChaoMuaFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.giaoThuong.ChaoMua.htm.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
    ...
    edit: function () {
        var s = '';
        if (jQuery('#GiaoThuongChaoMuaFnMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#GiaoThuongChaoMuaFnMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
            alert('Chọn mẩu tin để sửa');
        }
...
//        var _Hot4 = Hot4.is(':checked');
        ...
        if (_LangBased_ID != '' && eval(_LangBased) == false) {
            $.ajax({
                url: GiaoThuongChaoMuaFn.urlDefault().toString() + '&subAct=CountLang',
                dataType: 'script',
                data: {
                    'ID': _LangBased_ID,
                    'Lang': _Lang
...
//                    'Hot4': _Hot4
    ...
    del: function () {
        var s = '';
        s = jQuery('#GiaoThuongChaoMuaFnMdl-List').jqGrid('getGridParam', 'selarrrow').toString();
    ...
    AddLang: function () {
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                var treedata = $("#GiaoThuongChaoMuaFnMdl-List").jqGrid('getRowData', s);
    ...
    PheDuyet: function (active) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn duyệt các mẩu tin này?')) {
                $.ajax({
                    url: GiaoThuongChaoMuaFn.urlDefault().toString() + '&subAct=PheDuyet' + '&active='+ active,
                    dataType: 'script',
                    data: {
                        'ID': s,
                    },
