...
[assembly: WebResource("cnn.plugin.giaoThuong.ChaoBan.JScript1.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResource("cnn.plugin.giaoThuong.ChaoBan.htm.htm", "text/html", PerformSubstitution = true)]
namespace cnn.plugin.giaoThuong.ChaoBan
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                ...
                case "get":
                    ...
                    Pager<GiaoThuong> PagerGet = GiaoThuongDal.pagerNormal("", false, jgrsidx + " " + jgrsord, _q, _dm, "", _active, _publish, _Lang, Convert.ToInt32(jgRows), _dmkv, "False", _trangthai);
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.giaoThuong.ChaoBan.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region Nạp
                    ...
                    sb.Append(@"
                 <div id=""GiaoThuongChaoBanFnMdl-main"">   
                    <div id=""GiaoThuongChaoBanFnMdl-head"" class=""mdl-head"">
                        <span class=""mdl-head-searchPnl ui-state-default ui-corner-all"">
                            <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                            <input type=""text"" class=""mdl-head-txt mdl-head-search mdl-head-search-GiaoThuongChaoBan"" />
                        </span>
                        <a class=""mdl-head-btn mdl-head-edit"" id=""GiaoThuongChaoBanFnMdl-editBtn"" href=""javascript:"" onclick=""GiaoThuongChaoBanFn.edit();"">Sửa</a>
                        <a class=""mdl-head-btn mdl-head-del"" id=""GiaoThuongChaoBanFnMdl-delBtn"" href=""javascript:"" onclick=""GiaoThuongChaoBanFn.del();"" >Xóa</a>
                        <a class=""mdl-head-btn mdl-head-del"" id=""GiaoThuongChaoBanFnMdl-PheDuyetBtn"" href=""javascript:"" onclick=""GiaoThuongChaoBanFn.PheDuyet('True');"" >Phê duyệt</a>
                        <select class=""slt"" onchange=""GiaoThuongChaoBanFn.search();"" id=""GiaoThuongChaoBanFnMdl-changeLangSlt""></select>
                        <select class=""TrangThai"" onchange=""GiaoThuongChaoBanFn.search();"" id=""GiaoThuongChaoBanFnMdl-TrangThai""></select>
                        <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                            <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                            <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterDanhMucGiaoThuongChaoBan""/>
                        </span>
                        <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                            <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                            <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterKhuVucGiaoThuongChaoBan""/>
                        </span>
                        
                    </div>
                    <table id=""GiaoThuongChaoBanFnMdl-List"" class=""mdl-list""></table>
                    <div id=""GiaoThuongChaoBanFnMdl-Pager""></div>
                    <h3 style=""color: #2E6E9E;"">Ngôn ngữ khác, Thông tin về tin giao thương</h3>
                    <div class=""sub-mdl-list"" id=""GiaoThuongChaoBanFnMdl-subMdl"">
                        <ul>
                            <li><a href=""#GiaoThuongChaoBanFnMdl-subLangMdl"">Ngôn ngữ</a></li>
                            <li><a href=""#GiaoThuongChaoBanFnMdl-subNhomMdl"">Nhóm</a></li>
                            <li><a href=""#GiaoThuongChaoBanFnMdl-subAnhMdl"">Ảnh</a></li>
                        </ul>
                        <div  id=""GiaoThuongChaoBanFnMdl-subLangMdl"" class=""sub-mdl-list-item"">
                            <div class=""mdl-head"">
                                <a class=""mdl-head-btn mdl-head-AddLang"" id=""GiaoThuongChaoBanFnMdl-AddLangBtn"" href=""javascript:"" onclick=""GiaoThuongChaoBanFn.AddLang();"">Thêm ngôn ngữ khác</a>
                                <a class=""mdl-head-btn mdl-head-EditLang"" id=""GiaoThuongChaoBanFnMdl-EditLang"" href=""javascript:"" onclick=""GiaoThuongChaoBanFn.EditLang();"">Sửa</a>
                                <a class=""mdl-head-btn mdl-head-DelLang"" id=""GiaoThuongChaoBanFnMdl-DelLang"" href=""javascript:"" onclick=""GiaoThuongChaoBanFn.DelLang();"">Xóa</a>
                                <span class=""mdl-head-searchPnl ui-state-default ui-corner-all"">
                                    <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                    <input type=""text"" class=""mdl-head-txt mdl-head-search mdl-head-search-tinMdl-subTinNhomMdl"" />
                                </span>            
                            </div>
                            <table id=""GiaoThuongChaoBanFnMdl-subLangMdl-List"" class=""mdl-list""></table>
                        </div>
                        <div id=""GiaoThuongChaoBanFnMdl-subNhomMdl"" class=""sub-mdl-list-item"">
                            <div class=""mdl-head"">
                                <span class=""mdl-head-searchPnl ui-state-default ui-corner-all"">
                                    <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                            ...
                            <table id=""GiaoThuongChaoBanFnMdl-subNhomMdl-List"" class=""mdl-list""></table>
                        </div>
                        <div id=""GiaoThuongChaoBanFnMdl-subAnhMdl"" class=""sub-mdl-list-item"">
                            <div class=""mdl-head"">
                                <span class=""mdl-head-searchPnl ui-state-default ui-corner-all"">
                                    <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                            ...
                            <table id=""GiaoThuongChaoBanFnMdl-subAnhMdl-List"" class=""mdl-list""></table>
                        </div>
                    </div>
                </div>
                    ");
