...
using linh.common;
using cnn.entities;
[assembly: WebResource("cnn.plugin.language.htm.htm", "text/html", PerformSubstitution = true)]
[assembly: WebResource("cnn.plugin.language.JScript1.js", "text/javascript", PerformSubstitution = true)]

namespace cnn.plugin.language
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.language.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region nạp
