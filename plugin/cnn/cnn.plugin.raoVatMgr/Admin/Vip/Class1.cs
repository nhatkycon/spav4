...
using System.IO;
[assembly: WebResource("cnn.plugin.raoVatMgr.Admin.Vip.JScript1.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResource("cnn.plugin.raoVatMgr.Admin.Vip.htm.htm", "text/html")]
[assembly: WebResource("cnn.plugin.raoVatMgr.Admin.Vip.Dkdv.htm", "text/html")]
[assembly: WebResource("cnn.plugin.raoVatMgr.Admin.Vip.DuyetDKRVTP.htm", "text/html")]
namespace cnn.plugin.raoVatMgr.Admin.Vip
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                ...
                case "get":
                    ...
                    Pager<RaoVat> PagerGet = RaoVatDal.pagerNormal("", false, jgrsidx + " " + jgrsord, _q, Convert.ToInt32(Request["rows"]), _DM_ID, "", _NC_ID, "", _Lang, "", "", "11");
                    int countrv = 0;
                    foreach (RaoVat item in PagerGet.List)
                    {
                        ...
                        ListRow.Add(new jgridRow(item.ID.ToString(), new string[]{
                            ...
                            ,item.VIP_VIP_NgayBatDau_Active.ToString("dd/MM/yyyy")
                            ,item.VIP_VIP_NgayHetHan_Active.ToString("dd/MM/yyyy")
                        }));
                    }
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.raoVatMgr.Admin.Vip.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region
                    ...
                    sb.Append(@"
                    <div id=""RaoVatAdminVipFnMdl-main"">   
                        <div id=""RaoVatAdminVipFnMdl-head"" class=""mdl-head"">
                            <span class=""mdl-head-searchPnl ui-state-default ui-corner-all"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" class=""mdl-head-txt mdl-head-search mdl-head-search-RaoVatAdminVip"" />
                            </span>
                            <a class=""mdl-head-btn mdl-head-edit"" id=""RaoVatAdminVipFnMdl-editBtn"" href=""javascript:"" onclick=""RaoVatAdminVipFn.edit();"">Sửa</a>
                            <a class=""mdl-head-btn mdl-head-del"" id=""RaoVatAdminVipFnMdl-delBtn"" href=""javascript:"" onclick=""RaoVatAdminVipFn.del();"" >Xóa</a>
                            <a class=""mdl-head-btn mdl-head-del"" id=""RaoVatAdminVipFnMdl-PheDuyetBtn"" href=""javascript:"" onclick=""RaoVatAdminVipFn.DangTinDungTin('False');"" >Dừng</a>
                            <select class=""slt"" onchange=""RaoVatAdminVipFn.search();"" id=""RaoVatAdminVipFnMdl-changeLangSlt""></select>
                            <select class=""TrangThai"" onchange=""RaoVatAdminVipFn.search();"" id=""RaoVatAdminVipFnMdl-TrangThai""></select>
                            <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterLoaiTinRaoVatAdminVip""/>
                            </span>    
                            <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterDanhMucRaoVatAdminVip""/>
                            </span>
                            <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"" style=""display:none;"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterKhuVucRaoVatAdminVip""/>
                            </span>
                            <a class=""mdl-head-btn mdl-head-DKDV"" id=""RaoVatAdminVipFnMdl-DuyetDKDVBtn"" href=""javascript:"" onclick=""RaoVatAdminVipFn.LoadFormDKDVTraPhi('#RaoVatAdminVipFnMdl-List');"" >Gia hạn dịch vụ</a>
                        </div>
                        <table id=""RaoVatAdminVipFnMdl-List"" class=""mdl-list""></table>
                        <div id=""RaoVatAdminVipFnMdl-Pager""></div>
                    </div>
                    ");
                    sb.AppendFormat(@"<script>$.getScript('{0}',function(){1});</script>"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.raoVatMgr.Admin.Vip.JScript1.js")
                        , "{RaoVatAdminVipFn.loadgrid();}");
