RaoVatAdminVipFn = {
    urlDefault: function () { return adm.urlDefault + '&act=loadPlug&rqPlug=cnn.plugin.raoVatMgr.Admin.Vip.Class1, cnn.plugin.raoVatMgr'; },
    setup: function () { },
    loadgrid: function () {
        adm.styleButton();
        ...
        adm.regType(typeof (languageFn), 'cnn.plugin.language.Class1, cnn.plugin.language', function () {
            languageFn.setup(function () {
                $('#RaoVatAdminVipFnMdl-List').jqGrid({
                    url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=get&'+'&trangthai=11',
                    datatype: 'json',
                    loadui: 'disable',
                    ...
                    multiselect: true,
                    multiboxonly: true,
                    pager: $('#RaoVatAdminVipFnMdl-Pager'),
                    onSelectRow: function (rowid) {
                    },
                    loadComplete: function () {
                        adm.loading(null);
                        var txtfilter = $('.mdl-head-filterDanhMucRaoVatAdminVip', '#RaoVatAdminVipFnMdl-head');
                        var txtfilterTINH = $('.mdl-head-filterKhuVucRaoVatAdminVip', '#RaoVatAdminVipFnMdl-head');
                        var txtfilterLoaiTin = $('.mdl-head-filterLoaiTinRaoVatAdminVip', '#RaoVatAdminVipFnMdl-head');
                ...
                var filterLoaiDanhMucID = $('.mdl-head-filterDanhMucRaoVatAdminVip', '#RaoVatAdminVipFnMdl-head');
                var filterTINHID = $('.mdl-head-filterKhuVucRaoVatAdminVip', '#RaoVatAdminVipFnMdl-head');
                var filterLoaiTin = $('.mdl-head-filterLoaiTinRaoVatAdminVip', '#RaoVatAdminVipFnMdl-head');
                var searchTxt = $('.mdl-head-search-RaoVatAdminVip', '#RaoVatAdminVipFnMdl-head');
                ...
                var TrangThai = $('#RaoVatAdminVipFnMdl-TrangThai');
                ...
                //                var muaban = $('#RaoVatAdminVipFnMdl-muaban');
                ...
                var changeLangBtn = $('#RaoVatAdminVipFnMdl-changeLangSlt');
    ...
    search: function () {
        var timerSearch;
        var filterDM = $('.mdl-head-search-RaoVatAdminVip');
        var searchDM = $('.mdl-head-filterDanhMucRaoVatAdminVip');
        var searchTINH = $('.mdl-head-filterKhuVucRaoVatAdminVip');
        var searchLoaiTin = $('.mdl-head-filterLoaiTinRaoVatAdminVip', '#RaoVatAdminVipFnMdl-head');
        var _Lang = $('#RaoVatAdminVipFnMdl-changeLangSlt').val();
        var filtermuaban = $('#RaoVatAdminVipFnMdl-muaban');
        var filterTrangThai = $('#RaoVatAdminVipFnMdl-TrangThai');
        var q = filterDM.val();
        if (q == 'Tìm kiếm tin') {
            q = '';
        }
        ...
        timerSearch = setTimeout(function () {
            $('#RaoVatAdminVipFnMdl-List').jqGrid('setGridParam', { url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=get&dm=' + dm + '&dmkv=' + tinh + '&Lang=' + _Lang + '&q=' + q + '&muaban=' + loaitin + '&trangthai=' + trangthai }).trigger('reloadGrid');
        }, 500);
    },
    loadHtml: function (fn) {
        var dlg = $('#RaoVatAdminVipFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.Admin.Vip.htm.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
    ...
    add: function () {
        RaoVatAdminVipFn.loadHtml(function () {
            var newDlg = $('#RaoVatAdminVipFnMdl-dlgNew');
            ...
            $(newDlg).dialog({
                ...
                buttons: {
                    'Lưu': function () {
                        RaoVatAdminVipFn.save(false, function () {
                            RaoVatAdminVipFn.clearform();
                            jQuery('#RaoVatAdminVipFnMdl-List').trigger('reloadGrid');
                        });
                    },
    ...
    save: function (validate, fn) {
        ...
        $.ajax({
            url: RaoVatAdminVipFn.urlDefault().toString(),
            dataType: 'script',
            type: 'POST',
            data: {
                'subAct': 'save',
    ...
    edit: function () {
        var s = '';
        if (jQuery('#RaoVatAdminVipFnMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#RaoVatAdminVipFnMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
                ...
                RaoVatAdminVipFn.loadHtml(function () {
                    ...
                    $(newDlg).dialog({
                        ...
                        open: function () {
                            ...
                            adm.styleButton();
                            $.ajax({
                                url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=edit',
                                dataType: 'script',
                                data: {
                                    'ID': s
                                },
    ...
    del: function () {
        var s = '';
        s = jQuery('#RaoVatAdminVipFnMdl-List').jqGrid('getGridParam', 'selarrrow').toString();
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn xóa?')) {
                $.ajax({
                    url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=del',
                    dataType: 'script',
                    data: { 'ID': s },
                    success: function (dt) {
                        jQuery('#RaoVatAdminVipFnMdl-List').trigger('reloadGrid');
    ...
    PheDuyet: function (active) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn duyệt các mẩu tin này?')) {
                $.ajax({
                    url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=PheDuyet' + '&active=' + active,
                    dataType: 'script',
                    data: {
                        'ID': s
                    },
    ...
    DangTinDungTin: function (Publish) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc muốn đăng các mẩu tin này?')) {
                $.ajax({
                    url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=DangTinDungTin' + '&Publish='+ Publish,
                    dataType: 'script',
                    data: {
                        'ID': s,
                    },
    ...
    popfndkdv: function () {
        var newDlg = $('#RaoVatAdminVipFnMdl-DKDVFnMdl-dlgNew');
...
//        GhiChuDKDVTT.html('');
    ...
    loadHtmlDKDV: function (fn) {
        var dlg = $('#RaoVatAdminVipFnMdl-DKDVFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.Admin.Vip.Dkdv.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
                    if (typeof (fn) == 'function') {
    ...
    TinhGiaCuoc: function(NgayHetHan, NgayBatDau,Gia){
        ...
        if(parent.Date(EndDate) > parent.Date(StartDate)){
            var SoNgay = RaoVatAdminVipFn.dateDiff(d,EndDate,StartDate);
            //////console.log(SoNgay);
    ...
    DKDV: function () {
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                RaoVatAdminVipFn.loadHtmlDKDV(function () {
                    RaoVatAdminVipFn.popfndkdv();
                    var newDlg = $('#RaoVatAdminVipFnMdl-DKDVFnMdl-dlgNew');
                    $(newDlg).dialog({
                    ...
                    beforeClose: function () {
                        RaoVatAdminVipFn.clearformdkdv();
                    },
                        open: function () {
...
//                                    });
                            ...
                            //////console.log('2');
                            $.ajax({
                                url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=LoadHoTroDKDV',
                                dataType: 'script',
                                data: {
                                    'MaDanhMuc':'LIENHE'
                                },
                            ...
                            $.ajax({
                                url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=LoadThanhToanDanhMuc',
                                dataType: 'script',
                                data: {
                                },
                                success: function (dt) {
...
//                                        }
                                    ...
                                    NgayBatDauSuper.change(function(){
                                        TongTienSuper.html('');
                                        SoNgayDangTinSuperhtm.html('');
                                        var convertDateNgayHetHanSuper = RaoVatAdminVipFn.convertDate(NgayHetHanSuper.val(),'/');
                                        var convertDateNgayBatDauSuper = RaoVatAdminVipFn.convertDate(NgayBatDauSuper.val(),'/'); 
                                        var SoNgayDangKySuper = RaoVatAdminVipFn.dateDiff('d',convertDateNgayBatDauSuper,convertDateNgayHetHanSuper);
                                    ...
                                    NgayBatDauHot.change(function(){
                                        TongTienHot.html('');
                                        SoNgayDangTinHothtm.html('');
                                        var convertDateNgayHetHanHot = RaoVatAdminVipFn.convertDate(NgayHetHanHot.val(),'/');
                                        var convertDateNgayBatDauHot = RaoVatAdminVipFn.convertDate(NgayBatDauHot.val(),'/'); 
                                        var SoNgayDangKyHot = RaoVatAdminVipFn.dateDiff('d',convertDateNgayBatDauHot,convertDateNgayHetHanHot);
                                    ...
                                    NgayHetHanVip.change(function(){
                                        TongTienVip.html('');
                                        SoNgayDangTinViphtm.html('');
                                        var convertDateNgayHetHanVip = RaoVatAdminVipFn.convertDate(NgayHetHanVip.val(),'/');
                                        var convertDateNgayBatDauVip = RaoVatAdminVipFn.convertDate(NgayBatDauVip.val(),'/'); 
                                        var SoNgayDangKyVip = RaoVatAdminVipFn.dateDiff('d',convertDateNgayBatDauVip,convertDateNgayHetHanVip);
    ...
    saveDKDVVIP: function(validate, fn){
        ...
        adm.loading('Đang lưu dữ liệu');
        $.ajax({
            url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=DKDV',
            dataType: 'script',
            type: 'POST',
            data: {
                'ID': _ID,
            ...
            success: function (dt) {
                ...
                if (dt == '1') {
                    ...
                    var ThongTinRaoVatTrangThaiDKDV = $('.ThongTin-RaoVat-TrangThaiDKDV',newDlg);
                    //////console.log(_ID);
                    RaoVatAdminVipFn.LoadDichVuDaDangKy(ThongTinRaoVatTrangThaiDKDV,_ID);
                }
                else {
                    spbMsg.html('Lỗi máy chủ, chưa thể lưu được dữ liệu');
                }
    ...
    sendLienHe: function (validate, fn) {
        ...
        $.ajax({
            url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=lienHe',
            dataType: 'script',
            data: {
                'ID': ID,
    ...
    LoadFormDKDVTraPhiHtml: function (fn) {
        var dlg = $('#RaoVatAdminVip-DKDV-Dlg');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.Admin.Vip.DuyetDKRVTP.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
                    if (typeof (fn) == 'function') {
    ...
    LoadFormDKDVTraPhi: function (_grid) {
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                RaoVatAdminVipFn.LoadFormDKDVTraPhiHtml(function () {
                    var newDlg = $('#RaoVatAdminVip-DKDV-Dlg');
                    $(newDlg).dialog({
                        ...
                        buttons: {
                            'Duyệt và đóng': function () {
                                RaoVatAdminVipFn.SaveDKDVTraPhi(false, function () {
                                    $(newDlg).dialog('close');
                                    jQuery('#RaoVatAdminVipFnMdl-List').trigger('reloadGrid');
                                });
                            },
                        ...
                        beforeClose: function () {
                            RaoVatAdminVipFn.ClearFormDKDVTraPhi();
                        },
                        open: function () {
                            adm.styleButton();
                            RaoVatAdminVipFn.ClearFormDKDVTraPhi();
                            RaoVatAdminVipFn.popfnFormDKDVTraPhi();
                            $.ajax({
                                url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=edit',
                                dataType: 'script',
                                data: {
    ...
    SaveDKDVTraPhi: function(validate,fn){
        ...
        var err = '';
        if(cbkvip == true){
            var convertDateNgayHetHanSuper = RaoVatAdminVipFn.convertDate(NgayKT,'/');
            var convertDateNgayBatDauSuper = RaoVatAdminVipFn.convertDate(NgayBD,'/');
            if(Date.parse(convertDateNgayHetHanSuper) < Date.parse(convertDateNgayBatDauSuper)){
                err += 'ngày kết thúc phải lớn hơn ngày đăng ký';
            }
            if(NgayBD ==''){
        ...
        adm.loading('Đang lưu dữ liệu');
        $.ajax({
            url: RaoVatAdminVipFn.urlDefault().toString() + '&subAct=DuyetDKDVRVTP',
            dataType: 'script',
            type: 'POST',
            data: {
                'ID': _ID,
