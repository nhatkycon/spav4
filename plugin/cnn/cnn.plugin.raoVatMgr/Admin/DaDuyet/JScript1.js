RaoVatAdminDaDuyetFn = {
    urlDefault: function () { return adm.urlDefault + '&act=loadPlug&rqPlug=cnn.plugin.raoVatMgr.Admin.DaDuyet.Class1, cnn.plugin.raoVatMgr'; },
    setup: function () { },
    loadgrid: function () {
        adm.styleButton();
        ...
        adm.regType(typeof (languageFn), 'cnn.plugin.language.Class1, cnn.plugin.language', function () {
            languageFn.setup(function () {
                $('#RaoVatAdminDaDuyetFnMdl-List').jqGrid({
                    url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=get&Lang=' + Lang+'&trangthai=10',
                    datatype: 'json',
                    loadui: 'disable',
                    ...
                    multiselect: true,
                    multiboxonly: true,
                    pager: $('#RaoVatAdminDaDuyetFnMdl-Pager'),
                    onSelectRow: function (rowid) {
                    },
                    loadComplete: function () {
                        adm.loading(null);
                        var txtfilter = $('.mdl-head-filterDanhMucRaoVatAdminDaDuyet', '#RaoVatAdminDaDuyetFnMdl-head');
                        var txtfilterTINH = $('.mdl-head-filterKhuVucRaoVatAdminDaDuyet', '#RaoVatAdminDaDuyetFnMdl-head');
                        var txtfilterLoaiTin = $('.mdl-head-filterLoaiTinRaoVatAdminDaDuyet', '#RaoVatAdminDaDuyetFnMdl-head');
                ...
                var filterLoaiDanhMucID = $('.mdl-head-filterDanhMucRaoVatAdminDaDuyet', '#RaoVatAdminDaDuyetFnMdl-head');
                var filterTINHID = $('.mdl-head-filterKhuVucRaoVatAdminDaDuyet', '#RaoVatAdminDaDuyetFnMdl-head');
                var filterLoaiTin = $('.mdl-head-filterLoaiTinRaoVatAdminDaDuyet', '#RaoVatAdminDaDuyetFnMdl-head');
                var searchTxt = $('.mdl-head-search-RaoVatAdminDaDuyet', '#RaoVatAdminDaDuyetFnMdl-head');
                ...
                var TrangThai = $('#RaoVatAdminDaDuyetFnMdl-TrangThai');
                ...
                //                var muaban = $('#RaoVatAdminDaDuyetFnMdl-muaban');
                ...
                var changeLangBtn = $('#RaoVatAdminDaDuyetFnMdl-changeLangSlt');
    ...
    search: function () {
        var timerSearch;
        var filterDM = $('.mdl-head-search-RaoVatAdminDaDuyet');
        var searchDM = $('.mdl-head-filterDanhMucRaoVatAdminDaDuyet');
        var searchTINH = $('.mdl-head-filterKhuVucRaoVatAdminDaDuyet');
        var searchLoaiTin = $('.mdl-head-filterLoaiTinRaoVatAdminDaDuyet', '#RaoVatAdminDaDuyetFnMdl-head');
        var _Lang = $('#RaoVatAdminDaDuyetFnMdl-changeLangSlt').val();
        var filtermuaban = $('#RaoVatAdminDaDuyetFnMdl-muaban');
        var filterTrangThai = $('#RaoVatAdminDaDuyetFnMdl-TrangThai');
        var q = filterDM.val();
        if (q == 'Tìm kiếm tin') {
            q = '';
        }
        ...
        timerSearch = setTimeout(function () {
            $('#RaoVatAdminDaDuyetFnMdl-List').jqGrid('setGridParam', { url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=get&dm=' + dm + '&dmkv=' + tinh + '&Lang=' + _Lang + '&q=' + q + '&muaban=' + loaitin + '&trangthai=' + trangthai }).trigger('reloadGrid');
        }, 500);
    },
    loadHtml: function (fn) {
        var dlg = $('#RaoVatAdminDaDuyetFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.Admin.DaDuyet.htm.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
    ...
    add: function () {
        RaoVatAdminDaDuyetFn.loadHtml(function () {
            var newDlg = $('#RaoVatAdminDaDuyetFnMdl-dlgNew');
            ...
            $(newDlg).dialog({
                ...
                buttons: {
                    'Lưu': function () {
                        RaoVatAdminDaDuyetFn.save(false, function () {
                            RaoVatAdminDaDuyetFn.clearform();
                            jQuery('#RaoVatAdminDaDuyetFnMdl-List').trigger('reloadGrid');
                        });
                    },
    ...
    save: function (validate, fn) {
        ...
        $.ajax({
            url: RaoVatAdminDaDuyetFn.urlDefault().toString(),
            dataType: 'script',
            type: 'POST',
            data: {
                'subAct': 'save',
    ...
    edit: function () {
        var s = '';
        if (jQuery('#RaoVatAdminDaDuyetFnMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#RaoVatAdminDaDuyetFnMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
                ...
                RaoVatAdminDaDuyetFn.loadHtml(function () {
                    ...
                    $(newDlg).dialog({
                        ...
                        open: function () {
                            ...
                            adm.styleButton();
                            $.ajax({
                                url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=edit',
                                dataType: 'script',
                                data: {
                                    'ID': s
                                },
    ...
    del: function () {
        var s = '';
        s = jQuery('#RaoVatAdminDaDuyetFnMdl-List').jqGrid('getGridParam', 'selarrrow').toString();
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn xóa?')) {
                $.ajax({
                    url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=del',
                    dataType: 'script',
                    data: { 'ID': s },
                    success: function (dt) {
                        jQuery('#RaoVatAdminDaDuyetFnMdl-List').trigger('reloadGrid');
    ...
    PheDuyet: function (active) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn duyệt các mẩu tin này?')) {
                $.ajax({
                    url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=PheDuyet' + '&active=' + active,
                    dataType: 'script',
                    data: {
                        'ID': s
                    },
    ...
    DangTinDungTin: function (Publish) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc muốn đăng các mẩu tin này?')) {
                $.ajax({
                    url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=DangTinDungTin' + '&Publish='+ Publish,
                    dataType: 'script',
                    data: {
                        'ID': s,
                    },
    ...
    popfndkdv: function () {
        var newDlg = $('#RaoVatAdminDaDuyetFnMdl-DKDVFnMdl-dlgNew');
...
//        GhiChuDKDVTT.html('');
    ...
    loadHtmlDKDV: function (fn) {
        var dlg = $('#RaoVatAdminDaDuyetFnMdl-DKDVFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.Admin.DaDuyet.Dkdv.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
                    if (typeof (fn) == 'function') {
    ...
    TinhGiaCuoc: function(NgayHetHan, NgayBatDau,Gia){
        ...
        if(parent.Date(EndDate) > parent.Date(StartDate)){
            var SoNgay = RaoVatAdminDaDuyetFn.dateDiff(d,EndDate,StartDate);
            //////console.log(SoNgay);
    ...
    DKDV: function () {
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                RaoVatAdminDaDuyetFn.loadHtmlDKDV(function () {
                    RaoVatAdminDaDuyetFn.popfndkdv();
                    var newDlg = $('#RaoVatAdminDaDuyetFnMdl-DKDVFnMdl-dlgNew');
                    $(newDlg).dialog({
                    ...
                    beforeClose: function () {
                        RaoVatAdminDaDuyetFn.clearformdkdv();
                    },
                        open: function () {
...
//                                    });
                            ...
                            //////console.log('2');
                            $.ajax({
                                url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=LoadHoTroDKDV',
                                dataType: 'script',
                                data: {
                                    'MaDanhMuc':'LIENHE'
                                },
                            ...
                            $.ajax({
                                url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=LoadThanhToanDanhMuc',
                                dataType: 'script',
                                data: {
                                },
                                success: function (dt) {
...
//                                        }
                                    ...
                                    NgayBatDauSuper.change(function(){
                                        TongTienSuper.html('');
                                        SoNgayDangTinSuperhtm.html('');
                                        var convertDateNgayHetHanSuper = RaoVatAdminDaDuyetFn.convertDate(NgayHetHanSuper.val(),'/');
                                        var convertDateNgayBatDauSuper = RaoVatAdminDaDuyetFn.convertDate(NgayBatDauSuper.val(),'/'); 
                                        var SoNgayDangKySuper = RaoVatAdminDaDuyetFn.dateDiff('d',convertDateNgayBatDauSuper,convertDateNgayHetHanSuper);
                                    ...
                                    NgayBatDauHot.change(function(){
                                        TongTienHot.html('');
                                        SoNgayDangTinHothtm.html('');
                                        var convertDateNgayHetHanHot = RaoVatAdminDaDuyetFn.convertDate(NgayHetHanHot.val(),'/');
                                        var convertDateNgayBatDauHot = RaoVatAdminDaDuyetFn.convertDate(NgayBatDauHot.val(),'/'); 
                                        var SoNgayDangKyHot = RaoVatAdminDaDuyetFn.dateDiff('d',convertDateNgayBatDauHot,convertDateNgayHetHanHot);
                                    ...
                                    NgayHetHanVip.change(function(){
                                        TongTienVip.html('');
                                        SoNgayDangTinViphtm.html('');
                                        var convertDateNgayHetHanVip = RaoVatAdminDaDuyetFn.convertDate(NgayHetHanVip.val(),'/');
                                        var convertDateNgayBatDauVip = RaoVatAdminDaDuyetFn.convertDate(NgayBatDauVip.val(),'/'); 
                                        var SoNgayDangKyVip = RaoVatAdminDaDuyetFn.dateDiff('d',convertDateNgayBatDauVip,convertDateNgayHetHanVip);
    ...
    saveDKDVVIP: function(validate, fn){
        ...
        adm.loading('Đang lưu dữ liệu');
        $.ajax({
            url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=DKDV',
            dataType: 'script',
            type: 'POST',
            data: {
                'ID': _ID,
            ...
            success: function (dt) {
                ...
                if (dt == '1') {
                    ...
                    var ThongTinRaoVatTrangThaiDKDV = $('.ThongTin-RaoVat-TrangThaiDKDV',newDlg);
                    //////console.log(_ID);
                    RaoVatAdminDaDuyetFn.LoadDichVuDaDangKy(ThongTinRaoVatTrangThaiDKDV,_ID);
                }
                else {
                    spbMsg.html('Lỗi máy chủ, chưa thể lưu được dữ liệu');
                }
    ...
    sendLienHe: function (validate, fn) {
        ...
        $.ajax({
            url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=lienHe',
            dataType: 'script',
            data: {
                'ID': ID,
    ...
    ChuyenTinBanGiong: function (_grid) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn muốn chuyển sáng tin bán giống?')) {
                $.ajax({
                    url: RaoVatAdminDaDuyetFn.urlDefault().toString() + '&subAct=ChuyenThanhTinBanGiong',
                    dataType: 'script',
                    data: { 'ID': s },
                    success: function (dt) {
                        if (dt == '1') {
