UserRaoVatMoiFn = {
    urlDefault: function () { return adm.urlDefault + '&act=loadPlug&rqPlug=cnn.plugin.raoVatMgr.User.RaoVatMoi.Class1, cnn.plugin.raoVatMgr'; },
    setup: function () { },
    loadgrid: function () {
        adm.styleButton();
        ...
        adm.regType(typeof (languageFn), 'cnn.plugin.language.Class1, cnn.plugin.language', function () {
            languageFn.setup(function () {
                $('#UserRaoVatMoiFnMdl-List').jqGrid({
                    url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=get&Lang=' + Lang,
                    datatype: 'json',
                    loadui: 'disable',
                    ...
                    multiselect: true,
                    multiboxonly: true,
                    pager: $('#UserRaoVatMoiFnMdl-Pager'),
                    onSelectRow: function (rowid) {
                    },
                    loadComplete: function () {
                        adm.loading(null);
                        var txtfilter = $('.mdl-head-filterDanhMucUserRaoVatMoi', '#UserRaoVatMoiFnMdl-head');
                        var txtfilterTINH = $('.mdl-head-filterKhuVucUserRaoVatMoi', '#UserRaoVatMoiFnMdl-head');
                        var txtfilterLoaiTin = $('.mdl-head-filterLoaiTinUserRaoVatMoi', '#UserRaoVatMoiFnMdl-head');
                ...
                var filterLoaiDanhMucID = $('.mdl-head-filterDanhMucUserRaoVatMoi', '#UserRaoVatMoiFnMdl-head');
                var filterTINHID = $('.mdl-head-filterKhuVucUserRaoVatMoi', '#UserRaoVatMoiFnMdl-head');
                var filterLoaiTin = $('.mdl-head-filterLoaiTinUserRaoVatMoi', '#UserRaoVatMoiFnMdl-head');
                var searchTxt = $('.mdl-head-search-UserRaoVatMoi', '#UserRaoVatMoiFnMdl-head');
                ...
                //                var muaban = $('#UserRaoVatMoiFnMdl-muaban');
                ...
                //                var TrangThai = $('#UserRaoVatMoiFnMdl-TrangThai');
                ...
                var changeLangBtn = $('#UserRaoVatMoiFnMdl-changeLangSlt');
    ...
    search: function () {
        var timerSearch;
        var filterDM = $('.mdl-head-search-UserRaoVatMoi');
        var searchDM = $('.mdl-head-filterDanhMucUserRaoVatMoi');
        var searchTINH = $('.mdl-head-filterKhuVucUserRaoVatMoi');
        var searchLoaiTin = $('.mdl-head-filterLoaiTinUserRaoVatMoi', '#UserRaoVatMoiFnMdl-head');
        var _Lang = $('#UserRaoVatMoiFnMdl-changeLangSlt').val();
        var filtermuaban = $('#UserRaoVatMoiFnMdl-muaban');
        var filterTrangThai = $('#UserRaoVatMoiFnMdl-TrangThai');
        var q = filterDM.val();
        if (q == 'Tìm kiếm tin') {
            q = '';
        }
        ...
        timerSearch = setTimeout(function () {
            $('#UserRaoVatMoiFnMdl-List').jqGrid('setGridParam', { url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=get&dm=' + dm + '&dmkv=' + tinh + '&Lang=' + _Lang + '&q=' + q + '&muaban=' + loaitin + '&trangthai=' + trangthai }).trigger('reloadGrid');
        }, 500);
    },
    loadHtml: function (fn) {
        var dlg = $('#UserRaoVatMoiFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.User.RaoVatMoi.htm.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
    ...
    add: function () {
        UserRaoVatMoiFn.loadHtml(function () {
            var newDlg = $('#UserRaoVatMoiFnMdl-dlgNew');
            ...
            $(newDlg).dialog({
                ...
                buttons: {
                    'Lưu': function () {
                        UserRaoVatMoiFn.save(false, function () {
                            UserRaoVatMoiFn.clearform();
                            jQuery('#UserRaoVatMoiFnMdl-List').trigger('reloadGrid');
                        });
                    },
    ...
    save: function (validate, fn) {
        ...
        $.ajax({
            url: UserRaoVatMoiFn.urlDefault().toString(),
            dataType: 'script',
            type: 'POST',
            data: {
                'subAct': 'save',
    ...
    edit: function () {
        var s = '';
        if (jQuery('#UserRaoVatMoiFnMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#UserRaoVatMoiFnMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
                ...
                UserRaoVatMoiFn.loadHtml(function () {
                    ...
                    $(newDlg).dialog({
                        ...
                        open: function () {
                            ...
                            adm.styleButton();
                            $.ajax({
                                url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=edit',
                                dataType: 'script',
                                data: {
                                    'ID': s
                                },
    ...
    del: function () {
        var s = '';
        s = jQuery('#UserRaoVatMoiFnMdl-List').jqGrid('getGridParam', 'selarrrow').toString();
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn xóa?')) {
                $.ajax({
                    url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=del',
                    dataType: 'script',
                    data: { 'ID': s },
                    success: function (dt) {
                        jQuery('#UserRaoVatMoiFnMdl-List').trigger('reloadGrid');
    ...
    PheDuyet: function (active) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn duyệt các mẩu tin này?')) {
                $.ajax({
                    url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=PheDuyet' + '&active=' + active,
                    dataType: 'script',
                    data: {
                        'ID': s
                    },
    ...
    DangTinDungTin: function (Publish) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc muốn đăng các mẩu tin này?')) {
                $.ajax({
                    url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=DangTinDungTin' + '&Publish='+ Publish,
                    dataType: 'script',
                    data: {
                        'ID': s,
                    },
    ...
    popfndkdv: function () {
        var newDlg = $('#UserRaoVatMoiFnMdl-DKDVFnMdl-dlgNew');
...
//        GhiChuDKDVTT.html('');
    ...
    loadHtmlDKDV: function (fn) {
        var dlg = $('#UserRaoVatMoiFnMdl-DKDVFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.User.RaoVatMoi.Dkdv.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
                    if (typeof (fn) == 'function') {
    ...
    TinhGiaCuoc: function(NgayHetHan, NgayBatDau,Gia){
        ...
        if(parent.Date(EndDate) > parent.Date(StartDate)){
            var SoNgay = UserRaoVatMoiFn.dateDiff(d,EndDate,StartDate);
            //////console.log(SoNgay);
    ...
    DKDV: function () {
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                UserRaoVatMoiFn.loadHtmlDKDV(function () {
                    UserRaoVatMoiFn.popfndkdv();
                    var newDlg = $('#UserRaoVatMoiFnMdl-DKDVFnMdl-dlgNew');
                    $(newDlg).dialog({
                    ...
                    beforeClose: function () {
                        ...
                        open: function () {
                            ...
                            var ThongTinRaoVatTrangThaiDKDV = $('.ThongTin-RaoVat-TrangThaiDKDV',newDlg);
                            UserRaoVatMoiFn.LoadDichVuDaDangKy(ThongTinRaoVatTrangThaiDKDV,s);
                            inputDKDVSuper.hide();
                            inputDKDVVip.hide();
                            inputDKDVHot.hide();
                            adm.loading('Đang nạp dữ liệu');
...
//                                    });
                            ...
                            //////console.log('2');
                            $.ajax({
                                url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=LoadHoTroDKDV',
                                dataType: 'script',
                                data: {
                                    'MaDanhMuc':'LIENHE'
                                },
                            ...
                            $.ajax({
                                url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=LoadThanhToanDanhMuc',
                                dataType: 'script',
                                data: {
                                },
                                success: function (dt) {
...
//                                        }
                                    ...
                                    NgayBatDauSuper.change(function(){
                                        TongTienSuper.html('');
                                        SoNgayDangTinSuperhtm.html('');
                                        var convertDateNgayHetHanSuper = UserRaoVatMoiFn.convertDate(NgayHetHanSuper.val(),'/');
                                        var convertDateNgayBatDauSuper = UserRaoVatMoiFn.convertDate(NgayBatDauSuper.val(),'/'); 
                                        var SoNgayDangKySuper = UserRaoVatMoiFn.dateDiff('d',convertDateNgayBatDauSuper,convertDateNgayHetHanSuper);
                                    ...
                                    NgayBatDauHot.change(function(){
                                        TongTienHot.html('');
                                        SoNgayDangTinHothtm.html('');
                                        var convertDateNgayHetHanHot = UserRaoVatMoiFn.convertDate(NgayHetHanHot.val(),'/');
                                        var convertDateNgayBatDauHot = UserRaoVatMoiFn.convertDate(NgayBatDauHot.val(),'/'); 
                                        var SoNgayDangKyHot = UserRaoVatMoiFn.dateDiff('d',convertDateNgayBatDauHot,convertDateNgayHetHanHot);
                                    ...
                                    NgayHetHanVip.change(function(){
                                        TongTienVip.html('');
                                        SoNgayDangTinViphtm.html('');
                                        var convertDateNgayHetHanVip = UserRaoVatMoiFn.convertDate(NgayHetHanVip.val(),'/');
                                        var convertDateNgayBatDauVip = UserRaoVatMoiFn.convertDate(NgayBatDauVip.val(),'/'); 
                                        var SoNgayDangKyVip = UserRaoVatMoiFn.dateDiff('d',convertDateNgayBatDauVip,convertDateNgayHetHanVip);
    ...
    saveDKDVVIP: function(validate, fn){
        ...
        adm.loading('Đang lưu dữ liệu');
        $.ajax({
            url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=DKDV',
            dataType: 'script',
            type: 'POST',
            data: {
                'ID': _ID,
            ...
            success: function (dt) {
                ...
                if (dt == '1') {
                    ...
                    var ThongTinRaoVatTrangThaiDKDV = $('.ThongTin-RaoVat-TrangThaiDKDV',newDlg);
                    //////console.log(_ID);
                    UserRaoVatMoiFn.LoadDichVuDaDangKy(ThongTinRaoVatTrangThaiDKDV,_ID);
                }
                else {
                    spbMsg.html('Lỗi máy chủ, chưa thể lưu được dữ liệu');
                }
    ...
    sendLienHe: function (validate, fn) {
        ...
        $.ajax({
            url: UserRaoVatMoiFn.urlDefault().toString() + '&subAct=lienHe',
            dataType: 'script',
            data: {
                'ID': ID,
