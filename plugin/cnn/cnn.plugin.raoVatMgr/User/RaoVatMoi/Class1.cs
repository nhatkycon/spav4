...
using System.IO;
[assembly: WebResource("cnn.plugin.raoVatMgr.User.RaoVatMoi.JScript1.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResource("cnn.plugin.raoVatMgr.User.RaoVatMoi.htm.htm", "text/html")]
[assembly: WebResource("cnn.plugin.raoVatMgr.User.RaoVatMoi.Dkdv.htm", "text/html")]
namespace cnn.plugin.raoVatMgr.User.RaoVatMoi
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                ...
                case "get":
                    ...
                    Pager<RaoVat> PagerGet = RaoVatDal.pagerNormal("", false, jgrsidx + " " + jgrsord, _q, Convert.ToInt32(Request["rows"]), _DM_ID, "", _NC_ID, Security.Username, _Lang, "False", "", "");
                    int countrv = 0;
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.raoVatMgr.User.RaoVatMoi.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region
                    ...
                    sb.Append(@"
                    <div id=""UserRaoVatMoiFnMdl-main"">   
                        <div id=""UserRaoVatMoiFnMdl-head"" class=""mdl-head"">
                            <span class=""mdl-head-searchPnl ui-state-default ui-corner-all"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" class=""mdl-head-txt mdl-head-search mdl-head-search-UserRaoVatMoi"" />
                            </span>
                            
                            <a class=""mdl-head-btn mdl-head-edit"" id=""UserRaoVatMoiFnMdl-editBtn"" href=""javascript:"" onclick=""UserRaoVatMoiFn.edit();"">Sửa</a>
                            <a class=""mdl-head-btn mdl-head-del"" id=""UserRaoVatMoiFnMdl-delBtn"" href=""javascript:"" onclick=""UserRaoVatMoiFn.del();"" >Xóa</a>
                            <a class=""mdl-head-btn mdl-head-dung"" id=""UserRaoVatMoiFnMdl-dungBtn"" href=""javascript:"" onclick=""UserRaoVatMoiFn.DangTinDungTin('True');"" >Đăng tin</a>
                            
                            <select class=""slt"" onchange=""UserRaoVatMoiFn.search();"" id=""UserRaoVatMoiFnMdl-changeLangSlt""></select>
                            <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterLoaiTinUserRaoVatMoi""/>
                            </span>    
                            <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterDanhMucUserRaoVatMoi""/>
                            </span>
                            <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"" style=""display:none;"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterKhuVucUserRaoVatMoi"" />
                            </span>
                            <a class=""mdl-head-btn mdl-head-DKDV"" id=""UserRaoVatMoiFnMdl-DKDVBtn"" href=""javascript:"" onclick=""UserRaoVatMoiFn.DKDV();"" >Đăng ký tin vip</a>
                        </div>
                        <table id=""UserRaoVatMoiFnMdl-List"" class=""mdl-list""></table>
                        <div id=""UserRaoVatMoiFnMdl-Pager""></div>
                    </div>
                    ");
                    sb.AppendFormat(@"<script>$.getScript('{0}',function(){1});</script>"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.raoVatMgr.User.RaoVatMoi.JScript1.js")
                        , "{UserRaoVatMoiFn.loadgrid();}");
...
//<a class=""mdl-head-btn mdl-head-add"" id=""UserRaoVatMoiFnMdl-addBtn"" href=""javascript:"" onclick=""UserRaoVatMoiFn.add();"">Thêm</a>