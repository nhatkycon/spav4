UserRaoVatVipDaDuyetFn = {
    urlDefault: function () { return adm.urlDefault + '&act=loadPlug&rqPlug=cnn.plugin.raoVatMgr.User.RaoVatVipDaDuyet.Class1, cnn.plugin.raoVatMgr'; },
    setup: function () { },
    loadgrid: function () {
        adm.styleButton();
        ...
        adm.regType(typeof (languageFn), 'cnn.plugin.language.Class1, cnn.plugin.language', function () {
            languageFn.setup(function () {
                $('#UserRaoVatVipDaDuyetFnMdl-List').jqGrid({
                    url: UserRaoVatVipDaDuyetFn.urlDefault().toString() + '&subAct=get&Lang=' + Lang,
                    datatype: 'json',
                    loadui: 'disable',
                    colNames: ['ID', 'STT', 'Mã tin', 'Ảnh', 'Tiêu đề', 'Mục', 'Loại tin', 'Ngày đăng', 'ĐK Vip thời gian'], // 'ĐK Super', , 'ĐK hot'
                    colModel: [
                    ...
                    multiselect: true,
                    multiboxonly: true,
                    pager: $('#UserRaoVatVipDaDuyetFnMdl-Pager'),
                    onSelectRow: function (rowid) {
                    },
                    loadComplete: function () {
                        adm.loading(null);
                        var txtfilter = $('.mdl-head-filterDanhMucUserRaoVatVipDaDuyet', '#UserRaoVatVipDaDuyetFnMdl-head');
                        var txtfilterTINH = $('.mdl-head-filterKhuVucUserRaoVatVipDaDuyet', '#UserRaoVatVipDaDuyetFnMdl-head');
                        var txtfilterLoaiTin = $('.mdl-head-filterLoaiTinUserRaoVatVipDaDuyet', '#UserRaoVatVipDaDuyetFnMdl-head');
                ...
                var filterLoaiDanhMucID = $('.mdl-head-filterDanhMucUserRaoVatVipDaDuyet', '#UserRaoVatVipDaDuyetFnMdl-head');
                var filterTINHID = $('.mdl-head-filterKhuVucUserRaoVatVipDaDuyet', '#UserRaoVatVipDaDuyetFnMdl-head');
                var filterLoaiTin = $('.mdl-head-filterLoaiTinUserRaoVatVipDaDuyet', '#UserRaoVatVipDaDuyetFnMdl-head');
                var searchTxt = $('.mdl-head-search-UserRaoVatVipDaDuyet', '#UserRaoVatVipDaDuyetFnMdl-head');
                ...
                //                var muaban = $('#UserRaoVatVipDaDuyetFnMdl-muaban');
                ...
                //                var TrangThai = $('#UserRaoVatVipDaDuyetFnMdl-TrangThai');
                ...
                var changeLangBtn = $('#UserRaoVatVipDaDuyetFnMdl-changeLangSlt');
    ...
    search: function () {
        var timerSearch;
        var filterDM = $('.mdl-head-search-UserRaoVatVipDaDuyet');
        var searchDM = $('.mdl-head-filterDanhMucUserRaoVatVipDaDuyet');
        var searchTINH = $('.mdl-head-filterKhuVucUserRaoVatVipDaDuyet');
        var searchLoaiTin = $('.mdl-head-filterLoaiTinUserRaoVatVipDaDuyet', '#UserRaoVatVipDaDuyetFnMdl-head');
        var _Lang = $('#UserRaoVatVipDaDuyetFnMdl-changeLangSlt').val();
        var filtermuaban = $('#UserRaoVatVipDaDuyetFnMdl-muaban');
        var filterTrangThai = $('#UserRaoVatVipDaDuyetFnMdl-TrangThai');
        var q = filterDM.val();
        if (q == 'Tìm kiếm tin') {
            q = '';
        }
        ...
        timerSearch = setTimeout(function () {
            $('#UserRaoVatVipDaDuyetFnMdl-List').jqGrid('setGridParam', { url: UserRaoVatVipDaDuyetFn.urlDefault().toString() + '&subAct=get&dm=' + dm + '&dmkv=' + tinh + '&Lang=' + _Lang + '&q=' + q + '&muaban=' + loaitin + '&trangthai=' + trangthai }).trigger('reloadGrid');
        }, 500);
    },
    loadHtml: function (fn) {
        var dlg = $('#UserRaoVatVipDaDuyetFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.User.RaoVatVipDaDuyet.htm.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
    ...
    add: function () {
        UserRaoVatVipDaDuyetFn.loadHtml(function () {
            var newDlg = $('#UserRaoVatVipDaDuyetFnMdl-dlgNew');
            ...
            $(newDlg).dialog({
                ...
                buttons: {
                    'Lưu': function () {
                        UserRaoVatVipDaDuyetFn.save(false, function () {
                            UserRaoVatVipDaDuyetFn.clearform();
                            jQuery('#UserRaoVatVipDaDuyetFnMdl-List').trigger('reloadGrid');
                        });
                    },
    ...
    save: function (validate, fn) {
        ...
        $.ajax({
            url: UserRaoVatVipDaDuyetFn.urlDefault().toString(),
            dataType: 'script',
            type: 'POST',
            data: {
                'subAct': 'save',
    ...
    edit: function () {
        var s = '';
        if (jQuery('#UserRaoVatVipDaDuyetFnMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#UserRaoVatVipDaDuyetFnMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
                ...
                UserRaoVatVipDaDuyetFn.loadHtml(function () {
                    ...
                    $(newDlg).dialog({
                        ...
                        open: function () {
                            ...
                            adm.styleButton();
                            $.ajax({
                                url: UserRaoVatVipDaDuyetFn.urlDefault().toString() + '&subAct=edit',
                                dataType: 'script',
                                data: {
                                    'ID': s
                                },
    ...
    del: function () {
        var s = '';
        s = jQuery('#UserRaoVatVipDaDuyetFnMdl-List').jqGrid('getGridParam', 'selarrrow').toString();
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn xóa?')) {
                $.ajax({
                    url: UserRaoVatVipDaDuyetFn.urlDefault().toString() + '&subAct=del',
                    dataType: 'script',
                    data: { 'ID': s },
                    success: function (dt) {
                        jQuery('#UserRaoVatVipDaDuyetFnMdl-List').trigger('reloadGrid');
    ...
    PheDuyet: function (active) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn duyệt các mẩu tin này?')) {
                $.ajax({
                    url: UserRaoVatVipDaDuyetFn.urlDefault().toString() + '&subAct=PheDuyet' + '&active=' + active,
                    dataType: 'script',
                    data: {
                        'ID': s
                    },
    ...
    popfndkdv: function () {
        var newDlgDKDV = $('#UserRaoVatVipDaDuyetFnMdl-DKDVFnMdl-dlgNew');
    ...
    loadHtmlDKDV: function (fn) {
        var dlg = $('#UserRaoVatVipDaDuyetFnMdl-DKDVFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.User.RaoVatVipDaDuyet.Dkdv.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
                    if (typeof (fn) == 'function') {
    ...
    DKDV: function () {
        ...
        if (s == '') {
            ...
            UserRaoVatVipDaDuyetFn.loadHtmlDKDV(function () {
                UserRaoVatVipDaDuyetFn.popfndkdv();
                var newDlgDKDV = $('#UserRaoVatVipDaDuyetFnMdl-DKDVFnMdl-dlgNew');
                $(newDlgDKDV).dialog({
                    title: 'Sửa',
                    width: 580,
                    ...
                    buttons: {
                        'Đăng ký dịch vụ và đóng': function () {
                            UserRaoVatVipDaDuyetFn.saveDKDV(false, function () {
                                UserRaoVatVipDaDuyetFn.clearformdkdv();
    ...
    saveDKDV: function (validate, fn) {
        //UserRaoVatVipDaDuyetFn.popfndkdv();
        var newDlg = $('#UserRaoVatVipDaDuyetFnMdl-DKDVFnMdl-dlgNew');
        var dkhot = 'False';
        var dkvip = 'False';
        var dksuper = 'False';
        ...
        adm.loading('Đang lưu dữ liệu');
        $.ajax({
            url: UserRaoVatVipDaDuyetFn.urlDefault().toString() + '&subAct=DKDV',
            dataType: 'script',
            type: 'POST',
            data: {
                'ID': _ID,
    ...
    HuyDangKy: function (all, _super, vip, hot) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn duyệt các mẩu tin này?')) {
                $.ajax({
                    url: UserRaoVatVipDaDuyetFn.urlDefault().toString() + '&subAct=HuyDichVu' + '&_calcelall=' + all + '&_super=' + _super + "&_vip=" + vip + "&_hot=" + hot,
                    dataType: 'script',
                    data: {
                        'ID': s
                    },
