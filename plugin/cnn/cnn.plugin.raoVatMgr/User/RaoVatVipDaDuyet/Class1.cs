...
using System.IO;
[assembly: WebResource("cnn.plugin.raoVatMgr.User.RaoVatVipDaDuyet.JScript1.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResource("cnn.plugin.raoVatMgr.User.RaoVatVipDaDuyet.htm.htm", "text/html")]
namespace cnn.plugin.raoVatMgr.User.RaoVatVipDaDuyet
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                ...
                case "get":
                    ...
                    Pager<RaoVat> PagerGet = RaoVatDal.pagerNormal("", false, jgrsidx + " " + jgrsord, _q, Convert.ToInt32(Request["rows"]), _DM_ID, "", _NC_ID, Security.Username, _Lang, _Publish, _Active, "11");
                    int countrv = 0;
                    foreach (RaoVat item in PagerGet.List)
                    {
                        ...
                        ListRow.Add(new jgridRow(item.ID.ToString(), new string[]{
                            ...
                            //,item.VIP_SUPER == true ? item.VIP_SUPER_NgayBatDau.ToString("dd/MM/yyyy")+"-"+item.VIP_SUPER_NgayHetHan.ToString("dd/MM/yyyy") : "Không đăng ký"
                            ,item.VIP_VIP == true ? item.VIP_VIP_NgayBatDau_Active.ToString("dd/MM/yyyy")+"-"+ item.VIP_VIP_NgayHetHan_Active.ToString("dd/MM/yyyy"): "Không đăng ký"
                            //,item.VIP_NoiBat == true ?item.VIP_NoiBat_NgayBatDau.ToString("dd/MM/yyyy")+"-"+ item.VIP_NoiBat_NgayHetHan.ToString("dd/MM/yyyy") : "Không đăng ký"
                        }));
                    }
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.raoVatMgr.User.RaoVatVipDaDuyet.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region
                    ...
                    sb.Append(@"
                    <div id=""UserRaoVatVipDaDuyetFnMdl-main"">   
                        <div id=""UserRaoVatVipDaDuyetFnMdl-head"" class=""mdl-head"">
                            <span class=""mdl-head-searchPnl ui-state-default ui-corner-all"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" class=""mdl-head-txt mdl-head-search mdl-head-search-UserRaoVatVipDaDuyet"" />
                            </span>
                            
                            <a class=""mdl-head-btn mdl-head-edit"" id=""UserRaoVatVipDaDuyetFnMdl-editBtn"" href=""javascript:"" onclick=""UserRaoVatVipDaDuyetFn.edit();"">Sửa</a>
                            <a class=""mdl-head-btn mdl-head-del"" id=""UserRaoVatVipDaDuyetFnMdl-delBtn"" href=""javascript:"" onclick=""UserRaoVatVipDaDuyetFn.del();"" >Xóa</a>
                            <select class=""slt"" onchange=""UserRaoVatVipDaDuyetFn.search();"" id=""UserRaoVatVipDaDuyetFnMdl-changeLangSlt""></select>
                            <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterLoaiTinUserRaoVatVipDaDuyet""/>
                            </span>    
                            <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterDanhMucUserRaoVatVipDaDuyet""/>
                            </span>
                            <span class=""mdl-head-filterPnl ui-state-default ui-corner-all"" style=""display:none;"">
                                <a href=""javascript:;"" class=""mdl-head-clearSearch""></a>
                                <input type=""text"" _value="""" class=""mdl-head-filter mdl-head-filterKhuVucUserRaoVatVipDaDuyet""/>
                            </span>
                        </div>
                        <table id=""UserRaoVatVipDaDuyetFnMdl-List"" class=""mdl-list""></table>
                        <div id=""UserRaoVatVipDaDuyetFnMdl-Pager""></div>
                    </div>
                    ");
                    sb.AppendFormat(@"<script>$.getScript('{0}',function(){1});</script>"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.raoVatMgr.User.RaoVatVipDaDuyet.JScript1.js")
                        , "{UserRaoVatVipDaDuyetFn.loadgrid();}");
