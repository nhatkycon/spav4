UserDanhSachTinRaoVatFn = {
    urlDefault: function () { return adm.urlDefault + '&act=loadPlug&rqPlug=cnn.plugin.raoVatMgr.User.DanhSachTinRaoVat.Class1, cnn.plugin.raoVatMgr'; },
    setup: function () { },
    loadgrid: function () {
        adm.styleButton();
        ...
        adm.regType(typeof (languageFn), 'cnn.plugin.language.Class1, cnn.plugin.language', function () {
            languageFn.setup(function () {
                $('#UserDanhSachTinRaoVatFnMdl-List').jqGrid({
                    url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=get&Lang=' + Lang,//+'&trangthai=10',
                    datatype: 'json',
                    loadui: 'disable',
                    colNames: ['ID','TT','Mã tin' ,'Ảnh', 'Tiêu đề', 'Tóm tắt', 'Danh mục RV', 'Loại tin', 'Ngày tạo'],
                    colModel: [
                        ...
                        { name: 'RV_MoTa', width: 150, resizable: true, sortable: true },
                    ...
                    multiselect: true,
                    multiboxonly: true,
                    pager: $('#UserDanhSachTinRaoVatFnMdl-Pager'),
                    onSelectRow: function (rowid) {
                    },
                    loadComplete: function () {
                        adm.loading(null);
                        var txtfilter = $('.mdl-head-filterDanhMucUserDanhSachTinRaoVat', '#UserDanhSachTinRaoVatFnMdl-head');
                        var txtfilterTINH = $('.mdl-head-filterKhuVucUserDanhSachTinRaoVat', '#UserDanhSachTinRaoVatFnMdl-head');
                        var txtfilterLoaiTin = $('.mdl-head-filterLoaiTinUserDanhSachTinRaoVat', '#UserDanhSachTinRaoVatFnMdl-head');
                        ...
                        adm.regType(typeof (danhmuc), 'docsoft.plugin.danhmuc.Class1, docsoft.plugin.danhmuc', function () {
                            danhmuc.autoCompleteLangBased("", "RAOVAT", txtfilter, function (event, ui) {
                                ...
                                UserDanhSachTinRaoVatFn.search();
                            });
                ...
                var filterLoaiDanhMucID = $('.mdl-head-filterDanhMucUserDanhSachTinRaoVat', '#UserDanhSachTinRaoVatFnMdl-head');
                var filterTINHID = $('.mdl-head-filterKhuVucUserDanhSachTinRaoVat', '#UserDanhSachTinRaoVatFnMdl-head');
                var filterLoaiTin = $('.mdl-head-filterLoaiTinUserDanhSachTinRaoVat', '#UserDanhSachTinRaoVatFnMdl-head');
                var searchTxt = $('.mdl-head-search-UserDanhSachTinRaoVat', '#UserDanhSachTinRaoVatFnMdl-head');
                ...
                var TrangThai = $('#UserDanhSachTinRaoVatFnMdl-TrangThai');
                ...
                //                var muaban = $('#UserDanhSachTinRaoVatFnMdl-muaban');
                ...
                var changeLangBtn = $('#UserDanhSachTinRaoVatFnMdl-changeLangSlt');
    ...
    search: function () {
        var timerSearch;
        var filterDM = $('.mdl-head-search-UserDanhSachTinRaoVat');
        var searchDM = $('.mdl-head-filterDanhMucUserDanhSachTinRaoVat');
        var searchTINH = $('.mdl-head-filterKhuVucUserDanhSachTinRaoVat');
        var searchLoaiTin = $('.mdl-head-filterLoaiTinUserDanhSachTinRaoVat', '#UserDanhSachTinRaoVatFnMdl-head');
        var _Lang = $('#UserDanhSachTinRaoVatFnMdl-changeLangSlt').val();
        var filtermuaban = $('#UserDanhSachTinRaoVatFnMdl-muaban');
        var filterTrangThai = $('#UserDanhSachTinRaoVatFnMdl-TrangThai');
        var q = filterDM.val();
        if (q == 'Tìm kiếm tin') {
            q = '';
        }
        ...
        timerSearch = setTimeout(function () {
            $('#UserDanhSachTinRaoVatFnMdl-List').jqGrid('setGridParam', { url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=get&dm=' + dm + '&dmkv=' + tinh + '&Lang=' + _Lang + '&q=' + q + '&muaban=' + loaitin + '&trangthai=' + trangthai }).trigger('reloadGrid');
        }, 500);
    },
    loadHtml: function (fn) {
        var dlg = $('#UserDanhSachTinRaoVatFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.User.DanhSachTinRaoVat.htm.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
    ...
    add: function () {
        UserDanhSachTinRaoVatFn.loadHtml(function () {
            var newDlg = $('#UserDanhSachTinRaoVatFnMdl-dlgNew');
            ...
            $(newDlg).dialog({
                ...
                buttons: {
                    'Lưu': function () {
                        UserDanhSachTinRaoVatFn.save(false, function () {
                            UserDanhSachTinRaoVatFn.clearform();
                            jQuery('#UserDanhSachTinRaoVatFnMdl-List').trigger('reloadGrid');
                        });
                    },
    ...
    save: function (validate, fn) {
        ...
        $.ajax({
            url: UserDanhSachTinRaoVatFn.urlDefault().toString(),
            dataType: 'script',
            type: 'POST',
            data: {
                'subAct': 'save',
    ...
    edit: function () {
        var s = '';
        if (jQuery('#UserDanhSachTinRaoVatFnMdl-List').jqGrid('getGridParam', 'selrow') != null) {
            s = jQuery('#UserDanhSachTinRaoVatFnMdl-List').jqGrid('getGridParam', 'selrow').toString();
        }
        if (s == '') {
                ...
                UserDanhSachTinRaoVatFn.loadHtml(function () {
                    ...
                    $(newDlg).dialog({
                        ...
                        open: function () {
                            ...
                            adm.styleButton();
                            $.ajax({
                                url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=edit',
                                dataType: 'script',
                                data: {
                                    'ID': s
                                },
    ...
    del: function () {
        var s = '';
        s = jQuery('#UserDanhSachTinRaoVatFnMdl-List').jqGrid('getGridParam', 'selarrrow').toString();
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn xóa?')) {
                $.ajax({
                    url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=del',
                    dataType: 'script',
                    data: { 'ID': s },
                    success: function (dt) {
                        jQuery('#UserDanhSachTinRaoVatFnMdl-List').trigger('reloadGrid');
    ...
    PheDuyet: function (active) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc chắn duyệt các mẩu tin này?')) {
                $.ajax({
                    url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=PheDuyet' + '&active=' + active,
                    dataType: 'script',
                    data: {
                        'ID': s
                    },
    ...
    DangTinDungTin: function (Publish) {
        ...
        if (s == '') {
            ...
            if (confirm('Bạn có chắc muốn đăng các mẩu tin này?')) {
                $.ajax({
                    url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=DangTinDungTin' + '&Publish='+ Publish,
                    dataType: 'script',
                    data: {
                        'ID': s,
                    },
    ...
    popfndkdv: function () {
        var newDlg = $('#UserDanhSachTinRaoVatFnMdl-DKDVFnMdl-dlgNew');
...
//        GhiChuDKDVTT.html('');
    ...
    loadHtmlDKDV: function (fn) {
        var dlg = $('#UserDanhSachTinRaoVatFnMdl-DKDVFnMdl-dlgNew');
        if ($(dlg).length < 1) {
            adm.loading('Dựng from');
            $.ajax({
                url: '<%=WebResource("cnn.plugin.raoVatMgr.User.DanhSachTinRaoVat.Dkdv.htm")%>',
                success: function (dt) {
                    adm.loading(null);
                    $('body').append(dt);
                    if (typeof (fn) == 'function') {
    ...
    TinhGiaCuoc: function(NgayHetHan, NgayBatDau,Gia){
        ...
        if(parent.Date(EndDate) > parent.Date(StartDate)){
            var SoNgay = UserDanhSachTinRaoVatFn.dateDiff(d,EndDate,StartDate);
            //////console.log(SoNgay);
    ...
    DKDV: function () {
        ...
        if (s == '') {
            ...
            if (s.indexOf(',') != -1) {
                ...
                UserDanhSachTinRaoVatFn.loadHtmlDKDV(function () {
                    UserDanhSachTinRaoVatFn.popfndkdv();
                    var newDlg = $('#UserDanhSachTinRaoVatFnMdl-DKDVFnMdl-dlgNew');
                    $(newDlg).dialog({
                    ...
                    beforeClose: function () {
                        UserDanhSachTinRaoVatFn.clearformdkdv();
                    },
                        open: function () {
                            //UserDanhSachTinRaoVatFn.LoadDichVuDaDangKy(ThongTinRaoVatTrangThaiDKDV,_ID);
                            var ThongTinRaoVatTrangThaiDKDV = $('.ThongTin-RaoVat-TrangThaiDKDV',newDlg);
                            UserDanhSachTinRaoVatFn.LoadDichVuDaDangKy(ThongTinRaoVatTrangThaiDKDV,s);
                            ...
                            $.ajax({
                                url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=LoadHoTroDKDV',
                                dataType: 'script',
                                data: {
                                    'MaDanhMuc':'LIENHE'
                                },
                            ...
                            $.ajax({
                                url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=LoadThanhToanDanhMuc',
                                dataType: 'script',
                                data: {
                                },
                                success: function (dt) {
...
//                                        }
                                    ...
                                    NgayBatDauSuper.change(function(){
                                        TongTienSuper.html('');
                                        SoNgayDangTinSuperhtm.html('');
                                        var convertDateNgayHetHanSuper = UserDanhSachTinRaoVatFn.convertDate(NgayHetHanSuper.val(),'/');
                                        var convertDateNgayBatDauSuper = UserDanhSachTinRaoVatFn.convertDate(NgayBatDauSuper.val(),'/'); 
                                        var SoNgayDangKySuper = UserDanhSachTinRaoVatFn.dateDiff('d',convertDateNgayBatDauSuper,convertDateNgayHetHanSuper);
                                    ...
                                    NgayBatDauHot.change(function(){
                                        TongTienHot.html('');
                                        SoNgayDangTinHothtm.html('');
                                        var convertDateNgayHetHanHot = UserDanhSachTinRaoVatFn.convertDate(NgayHetHanHot.val(),'/');
                                        var convertDateNgayBatDauHot = UserDanhSachTinRaoVatFn.convertDate(NgayBatDauHot.val(),'/'); 
                                        var SoNgayDangKyHot = UserDanhSachTinRaoVatFn.dateDiff('d',convertDateNgayBatDauHot,convertDateNgayHetHanHot);
                                    ...
                                    NgayHetHanVip.change(function(){
                                        TongTienVip.html('');
                                        SoNgayDangTinViphtm.html('');
                                        var convertDateNgayHetHanVip = UserDanhSachTinRaoVatFn.convertDate(NgayHetHanVip.val(),'/');
                                        var convertDateNgayBatDauVip = UserDanhSachTinRaoVatFn.convertDate(NgayBatDauVip.val(),'/'); 
                                        var SoNgayDangKyVip = UserDanhSachTinRaoVatFn.dateDiff('d',convertDateNgayBatDauVip,convertDateNgayHetHanVip);
    ...
    saveDKDVVIP: function(validate, fn){
        ...
        adm.loading('Đang lưu dữ liệu');
        $.ajax({
            url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=DKDV',
            dataType: 'script',
            type: 'POST',
            data: {
                'ID': _ID,
    ...
    sendLienHe: function (validate, fn) {
        ...
        $.ajax({
            url: UserDanhSachTinRaoVatFn.urlDefault().toString() + '&subAct=lienHe',
            dataType: 'script',
            data: {
                'ID': ID,
