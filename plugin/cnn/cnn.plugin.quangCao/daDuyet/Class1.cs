...
using System.Xml;
[assembly: WebResource("cnn.plugin.quangCao.daDuyet.JScript1.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResource("cnn.plugin.quangCao.daDuyet.htm.htm", "text/html")]
namespace cnn.plugin.quangCao.daDuyet
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.quangCao.daDuyet.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region nạp
