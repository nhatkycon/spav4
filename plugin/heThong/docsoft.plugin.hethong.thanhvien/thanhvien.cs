...
<div class=""sub-mdl-list"" id=""thanhvienmdl-rolemdl-mdl""></div>
        ...
        {
            omail.Send(_email, _title, _body, "gigawebhome@gmail.com", "Tạp chí Spa", "25111987");
        }
        void sendMailSingle(string _email, string _title, string _body)
        {
            omail.Send(_email, "Tạp chí Spa", _title, _body, "gigawebhome@gmail.com", "Tạp chí spa .com", "25111987");
        }
