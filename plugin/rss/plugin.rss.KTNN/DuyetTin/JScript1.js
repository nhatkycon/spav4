var DuyetTin_tinFn = {
    urlDefault: adm.urlDefault + '&act=loadPlug&rqPlug=plugin.rss.KTNN.DuyetTin.Class1, plugin.rss.KTNN',
    setup: function () {
    },
    loadgrid: function () {
        adm.loading('Đang lấy dữ liệu');
        adm.styleButton();
        $('#tinMdlds-List-duyet-ktnn').jqGrid({
            ...
            pager: jQuery('#tinMdlds-Pager-duyet-ktnn'),
            editurl: DuyetTin_tinFn.urlDefault + '&subAct=save',
            onSelectRow: function (rowid) {
               // var treedata = $("#tinMdlds-List-duyet-ktnn").jqGrid('getRowData', rowid);
            ...
            loadComplete: function () {
                ...
                //var searchTxt = $('.mdl-head-search-tinMdlds'); adm.regQS(searchTxt, 'tinMdlds-List-duyet-ktnn');
...
//                                    $('#tinMdlds-List-duyet-ktnn').jqGrid('setGridParam', { url: DuyetTin_tinFn.urlDefault
//                                    + '&subAct=get'
//                                    + '&Bao=' + _B_ID
//                                    + '&DM_ID=' + _DM_ID
//                                    + '&TpId=' + _T_ID
