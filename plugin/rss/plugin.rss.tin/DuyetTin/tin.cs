...
[assembly: WebResource("plugin.rss.tin.DuyetTin.JScript1.js", "text/javascript", PerformSubstitution = true)]

namespace plugin.rss.tin.DuyetTin
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                case "get":
                    ...
                    Pager<docbao.entitites.Tin> PagerGet = docbao.entitites.TinDal.pagerTinXuLy("", false, Convert.ToInt32(jgRows), jgrsidx + " " + jgrsord, _q, _DM_ID, _CM_ID, _Bao, _TpId, _Nid, _Ngay, _tag,"1");
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "plugin.rss.tin.DuyetTin.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region nạp
...
<div class=""mdl-head"">
    ...
    <a class=""mdl-head-btn mdl-head-del""  href=""javascript:;"" onclick=""$('#tinMdlds-List').trigger('reloadGrid');"">Nạp</a>
...
<table id=""tinMdlds-List"" class=""mdl-list""></table>
<div id=""tinMdlds-Pager""></div>
