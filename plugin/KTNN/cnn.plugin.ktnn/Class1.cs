...
using System.IO;
[assembly: WebResource("cnn.plugin.ktnn.JScript1.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResource("cnn.plugin.ktnn.htm.htm", "text/html")]
namespace cnn.plugin.ktnn
{
    public class Class1 : docPlugUI
    {
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            string _NoiDungql_ktnn = Request["NoiDungql_ktnn"];
            ...
            switch (subAct)
            {
                case "get":
                    ...
                    Pager<KTNN> PagerGet = KTNNDal.pagerNormalTin("", false, jgrsidx + " " + jgrsord, _q, _PID, _NguoiTao, _acp, "KT_NN", _Lang, Request["rows"]);
                ...
                case "del":
                    ...
                    if (!string.IsNullOrEmpty(_ID))
                    {
                        KTNNDal.DeleteMultiById(_ID, "KT_NN");
                    }
                    break;
                    #endregion
                case "duyet":
                ...
                case "save":
                    ...
                    ItemSave.MoTa = _Mota;
                    ItemSave.NoiDung = _NoiDungql_ktnn;
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "cnn.plugin.ktnn.JScript1.js"));
                    break;
                    #endregion
                case "saveDoc":
                    #region Lưu tài liệu
...
<input type=""text"" class=""mdl-head-txt mdl-head-search mdl-head-search-ktnn-ql"" />
</span>
<a class=""mdl-head-btn mdl-head-add"" id=""tinmdlktnn-addBtn"" href=""javascript:tinfn.add();"">Viết bài</a>
<a class=""mdl-head-btn mdl-head-add"" id=""danhMucMdl-addBtn"" href=""javascript:"" onclick=""tinfn.addLang();"" style=""display:none;"" >Bài viết ngôn ngữ khác</a>
<a class=""mdl-head-btn mdl-head-edit"" id=""tinmdlktnn-editBtn"" href=""javascript:tinfn.edit();"">Sửa bài viết</a>
<a class=""mdl-head-btn mdl-head-del"" id=""tinmdlktnn-delBtn"" href=""javascript:tinfn.del();"">Xóa bài viết</a>
<select class=""slt"" onchange=""tinfn.search();"" id=""Tintucdl-changeLangSlt""></select>
<a class=""mdl-head-btn mdl-headTask-Loc"" href=""javascript:;"">
    <span class=""mdl-headTask-Loc-Title"">
        <span class=""ui-icon ui-icon-triangle-1-s""></span>        
        Duyệt tin <span class=""mdl-headTask-Loc-Title-Display""></span>
    </span>
    <span class=""mdl-headTask-Loc-Box"">
        <span class=""mdl-headTask-Loc-Box-Pnl ui-widget-content ui-corner-bottom"">
            <span class=""mdl-headTask-Loc-Box-Content ui-corner-all"">
                <span onclick=""javascript:tinfn.duyet('true');"">Duyệt bài viết</span>
                <span onclick=""javascript:tinfn.duyet('false');"">Bỏ duyệt bài viết</span>
            </span>
        </span>
    </span>
</a>
<a class=""mdl-head-btn mdl-headTask-Loc"" href=""javascript:;"">
    ...
    <span class=""mdl-headTask-Loc-Box"">
        <span class=""mdl-headTask-Loc-Box-Pnl ui-widget-content ui-corner-bottom"">
            <span class=""mdl-headTask-Loc-Box-Content ui-corner-all"">
                <span onclick=""javascript:tinfn.tinhot('true');"">Chuyển tin hot</span>
                <span onclick=""javascript:tinfn.tinhot('false');"">Chuyển tin thường</span>
            </span>
        </span>
    </span>
</a>
<a class=""mdl-head-btn mdl-headTask-Loc"" href=""javascript:;"">
    ...
    <span class=""mdl-headTask-Loc-Box"">
        <span class=""mdl-headTask-Loc-Box-Pnl ui-widget-content ui-corner-bottom"">
            <span class=""mdl-headTask-Loc-Box-Content ui-corner-all"">
                <span onclick=""javascript:tinfn.hethan('true');"">Chuyển hết hạn</span>
                <span onclick=""javascript:tinfn.hethan('false');"">Gia hạn</span>
            </span>
        </span>
    </span>
</a>
<a class=""mdl-head-btn mdl-headTask-Loc"" href=""javascript:;"">
    ...
    <span class=""mdl-headTask-Loc-Box"">
        <span class=""mdl-headTask-Loc-Box-Pnl ui-widget-content ui-corner-bottom"">
            <span class=""mdl-headTask-Loc-Box-Content ui-corner-all"">
                <span onclick=""javascript:tinfn.hethan('true');"">Tin kích hoạt</span>
                <span onclick=""javascript:tinfn.hethan('false');"">Tin hot</span>
                <span onclick=""javascript:tinfn.hethan('false');"">Hết hạn</span>
            </span>
        </span>
    </span>
</a>
...
<table id=""tinmdlktnn-List"" class=""mdl-list""></table>
<div id=""tinmdlktnn-Pagerql""></div>");
